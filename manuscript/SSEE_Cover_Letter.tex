...
\begin{itemize}
  \item The bare ratios $w_0=-T_r/M_v=-0.840$ and $w_a=-P_{\rm sc}/\mathrm{IGNIS}=-0.670$
  ...
  CMB anchor as prior yields $H_0=67.95\pm0.40~\mathrm{km\,s^{-1}\,Mpc^{-1}}$
  ($0.04\sigma$ from the algebraic anchor), and the
