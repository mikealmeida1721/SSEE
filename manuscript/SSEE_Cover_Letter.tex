...
on 2026-08-01. \emph{Further updated 2026-09-20:} the same test against the
KiDS-Legacy release (357 raw $\xi_\pm$ points; Wright et al.\ 2025,
arXiv:2503.19441, published sixteen months before this analysis --- no
temporal priority is claimed) finds the shear asking for
$\log(10^{10}A_s)=3.0255\pm0.0396$ against the $3.04483$ the CMB fixes under
the same algebraic background, $0.49\sigma$. Fixing $A_s$ to that CMB value
costs nothing ($\chi^2=417.97$ with eight free parameters, all nuisance and
none cosmological, against $418.34$ with $A_s$ free; $\Delta\mathrm{BIC}=+6.24$),
so $S_8=0.8273$ becomes a prediction rather than a fit, against
$0.8265\pm0.0176$ measured. The three $\chi^2$ compared span $1.0$: the shear
does not discriminate between the models, and I make no claim that it
does.)} I have deliberately separated the algebraically fixed core from these
