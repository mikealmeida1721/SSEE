...
$66.41^{+0.39}_{-0.39}$~km\,s$^{-1}$\,Mpc$^{-1}$ by the MCMC analysis of
...
$m_\phi=41.02$~eV), whose free-streaming suppresses small-scale power below
$k_{\mathrm{fs}}=0.762\,h\,\mathrm{Mpc}^{-1}$, brings the prediction to
$\sigma_8=0.748$, $S_8=0.759$ ($0.01\sigma$ KiDS), resolving the tension.
...
the data at $0.16\sigma$ (Pantheon+; $0.2$--$1.5\sigma$ across SN compilations).
...
$S_8$ (CMB sector) & \checkmark Numerical & $0.837$ (IS bkg); $0.846$ (single-sector ceiling, Paper~5); $0.759$ (two-sector $\varphi$-DM, Paper~6; $0.01\sigma$ KiDS) \\
