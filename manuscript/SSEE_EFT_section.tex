...
%% All equations verified algebraically (see archive/codigo/investigacion/beta_c_RETIRADO_2026-09-07/ssee_eft_verification.py)
...
$67.79^{+0.35}_{-0.35}$~km\,s$^{-1}$\,Mpc$^{-1}$ by the MCMC analysis of
...
amplitude ceiling is $S_8=0.846$, $3.5\sigma$).  These figures hold $A_s$ fixed at the Planck value, which imports the
...
$\sigma_8=0.7446\pm0.0189$, $S_8=0.7555\pm0.0192$ (the $\Lambda$CDM control on the same raw data through the same pipeline gives $0.7571\pm0.0194$) --- $0.11\sigma$ from
...
$S_8$ (CMB sector) & \checkmark Numerical & $0.837$ (IS bkg); $0.846$ (single-sector ceiling, Paper~5); $0.7555\pm0.0192$ (single sector, $A_s$ free, raw KiDS $\xi_\pm$; Paper~6). The two-sector $0.758$ is retracted \\
