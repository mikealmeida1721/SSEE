...
$H_0^{\rm local} = 73.040$ km/s/Mpc, within $0.001\,\sigma$ of the SH0ES
central value ($73.04 \pm 1.04$ km/s/Mpc; Riess et~al.\ 2022).
...
km/s/Mpc, matching the SH0ES central value to within $0.001$ km/s/Mpc ($< 0.001\sigma$).
...
\caption{%
  ...
  gap of Papers~1--9 to $< 0.001\sigma$.
}
\label{tab:H0}
\begin{tabular}{lllll}
\toprule
...
UV ($M^4=45\alpha^2\rhoc$, this paper) & 0.41691 & 0.06952 & \textbf{73.040} & $< 0.001\sigma$ \\
\midrule
...
The UV cutoff $M^4 = 45\alpha^2\rhoc$ reduces the Hubble tension to $< 0.001\sigma$,
with $H_0^{\rm UV} = 73.040$ km/s/Mpc differing from the SH0ES central value by
$0.001$ km/s/Mpc --- below the resolution of the current measurement.
...
Paper 9 & $H_0^{\rm IR} = 72.86$ (0.17$\sigma$) & UV closes to 73.040 ($< 0.001\sigma$) \\
...
$H_0^{\rm UV} = 73.040$ km/s/Mpc, within $0.001$ km/s/Mpc ($< 0.001\sigma$)
of the SH0ES central value.
...
\begin{enumerate}
  ...
  \item The residual $0.17\sigma$ Hubble tension of Papers~1--9 is reduced to
        $< 0.001\sigma$ by the UV completion.
