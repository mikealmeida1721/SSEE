...
Applied to the canonical CMB-derived value $H_0^{\rm MIRA}=67.037$ this gives
$H_0^{\rm IR}=71.87$ km/s/Mpc ($1.12\sigma$ from SH0ES); applied to the Type~P
...
canonical $H_0^{\rm MIRA}=67.037$, the UV prediction is
$H_0^{\rm local,MIRA} \approx 72.05$ km/s/Mpc ($0.96\sigma$ from SH0ES) ---
...
$H_0^{\rm IR,MIRA} = 71.87$ km/s/Mpc ($1.12\sigma$ SH0ES; Paper~9) is
...
MIRA-calibrated CMB anchor $H_0^{\rm MIRA} = 67.04$ km/s/Mpc, giving
$H_0^{\rm IR,MIRA} = 71.87$ km/s/Mpc ($1.12\sigma$ from SH0ES) with zero free
...
$H_0^{\rm UV,MIRA} = 72.05$ km/s/Mpc ($0.96\sigma$ from SH0ES) --- the physically
...
evaluated at the model's physical Hubble rate $H_{\rm MIRA} = 67.04$~km/s/Mpc
...
($H_0^{\rm UV,MIRA}=72.05$, or $73.040$ on the Type-P anchor) is
...
\begin{equation}
  ...
  \;=\; \frac{67.037}{1 - 0.06952}
  \;=\; 72.05 \text{ km/s/Mpc}\,,
  \label{eq:H0UV}
\end{equation}
the canonical UV prediction ($0.96\sigma$ from SH0ES). On the Type-P anchor
...
\caption{%
  ...
  from $1.12\sigma$ (IR) to $0.96\sigma$ (UV), conditional on Postulate~C.1
...
\midrule
IR ($M\to\infty$, Papers 1--9) & 0.40330 & 0.06725 & 71.87 & $1.12\sigma$ \\
UV ($M^4=45\alpha^2\rhoc$, this paper) & 0.41691 & 0.06952 & \textbf{72.05} & $0.96\sigma$ (cond.$^{a}$) \\
\midrule
...
canonical MIRA anchor, $H_0^{\rm UV,MIRA} = 72.05$ km/s/Mpc ($0.96\sigma$ from
SH0ES) --- the headline UV prediction, improving the IR value $71.87$
($1.12\sigma$).  On the Type-P anchor $H_0^{\rm alg}=67.96$ the same correction
...
$H_0^{\rm UV,MIRA}=72.05$\,km/s/Mpc lies $\sim1.4\sigma$ above this anchor; the
canonical IR prediction $H_0^{\rm IR,MIRA}=71.87$\,km/s/Mpc lies $\sim1.3\sigma$
...
$H_0^{\rm UV,MIRA}$ & $H_0^{\rm MIRA}/(1-\fsc^{\rm UV})$ & \textbf{72.05} & Eq.~\eqref{eq:H0UV} \\
...
\begin{enumerate}
  \item LiteBIRD (2032) should measure $r \approx 0.00813$
        [from Eq.~\eqref{eq:r}].
  \item The local Hubble constant should be $H_0^{\rm local} = 72.05$
...
\begin{figure}[ht]
  ...
  \caption{%
    ...
    The canonical SSEE value $72.05$ km/s/Mpc falls inside the SH0ES band
...
$H_0^{\rm UV,MIRA}=72.05$ km/s/Mpc ($0.96\sigma$ from SH0ES). On the Type-P
...
\to H_0^{\rm UV,MIRA} = 72.05\;\mathrm{km/s/Mpc}$ ($0.96\sigma$ from SH0ES;
...
Paper 9 & $H_0^{\rm IR,MIRA} = 71.87$ (1.12$\sigma$) & UV closes to $72.05$ ($0.96\sigma$; conditional$^{a}$) \\
...
\bottomrule
\end{tabular}
\footnotesize{$^{a}$ Canonical UV result $H_0^{\rm UV,MIRA}=72.05$ km/s/Mpc ($0.96\sigma$ from SH0ES),
...
The canonical UV result $H_0^{\rm UV,MIRA} = 72.05$ km/s/Mpc ($0.96\sigma$ from
...
$H_0^{\rm UV,MIRA} = 72.05$ km/s/Mpc ($0.96\sigma$ from SH0ES), conditional on
...
\begin{enumerate}
  ...
  \item The canonical IR Hubble residual of Paper~9
        ($H_0^{\rm IR,MIRA}=71.87$, $1.12\sigma$) is reduced to
        $H_0^{\rm UV,MIRA}=72.05$ ($0.96\sigma$ from SH0ES) by the UV
