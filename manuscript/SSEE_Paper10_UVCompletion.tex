...
Paper~9 of this series~\citep{SSEE9} showed that within SSEE, the EFT
kineticity parameter $\alphaK = 0.403302$ \citep{SSEE7,SSEE8} and the lensing factor
...
\begin{figure}[ht]
  ...
  \caption{%
    ...
    At $\alpha = \varphi^4/3 = 2.284701$ (green dashed), $\alpha_K^{\rm full}=0.41691$
...
Paper 7 & $\alphaK^{\rm IR} = 0.403302$ & Base for UV correction (+3.37\%) \\
...
\bibitem{SSEE7}
M.~E.~Almeida Vallejo,
\emph{Canonical EFT of SSEE: $\beta_c = -\AURA$, $\alphaK = 0.403302$},
SSEE Paper~7 (2026).
