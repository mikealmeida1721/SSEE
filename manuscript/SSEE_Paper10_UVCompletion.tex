...
$M^4/\rhoc = 5\phiG^8 = 234.893569$, so the UV Hubble prediction
...
\to \fsc^{\rm UV} \to H_0^{\rm glob} = 67.96214\;\mathrm{km/s/Mpc}$
...
Paper 9 & $H_0^{\rm glob,IR} = 68.13$ (0.17$\sigma$) & UV closes to $67.96214$ ($4.3{\times}10^{-6}\sigma$; conditional$^{a}$) \\
...
\footnotesize{$^{a}$ Canonical UV result $H_0^{\rm glob,UV}=67.96214$ km/s/Mpc, obtained by running
the lens on the measured SH0ES rate, conditional on Postulate C.1 (UV-IR separability,
§\ref{sec:theorem}). The propagated uncertainty is $\pm0.970$ km/s/Mpc and dominates the
...
The canonical UV result $H_0^{\rm glob,UV} = 67.96214$ km/s/Mpc,
...
$\sK^{\rm full} = 0.41691$ and the global rate returned from the SH0ES datum is
$H_0^{\rm glob,UV} = 67.96214$ km/s/Mpc, conditional on
...
\begin{enumerate}
  ...
  \item The canonical IR Hubble residual of Paper~9
        ...
        $H_0^{\rm glob,UV}=67.96214$ ($4.2\times10^{-6}$) by the UV
