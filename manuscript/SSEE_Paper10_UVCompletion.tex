...
\begin{figure}[ht]
  ...
  \caption{%
    ...
    from the canonical cascade Eq.~(\ref{eq:Hpred}) with base
    $H_0^{\rm MIRA}=67.037$ km/s/Mpc (solid green), with the SH0ES band
    $73.04\pm1.04$ km/s/Mpc (red) and Planck $67.36\pm0.54$ km/s/Mpc (blue).
    ...
    At $\alpha=\varphi^4/3$ the canonical value is $72.05$ km/s/Mpc
    ($0.96\sigma$ from SH0ES), inside the SH0ES band.
  }
...
IR limit, and the discriminating observable remains $\alphaK$.
