...
$H_0 = 3(\varphi+\pi)^2$ & $67.962\,\mathrm{km\,s^{-1}\,Mpc^{-1}}$ & Planck 2018 & Global background anchor (Post.~D) \\
\midrule
...
recorded as \emph{below sensitivity} rather than as a falsifier), versus the \emph{effective background} value
