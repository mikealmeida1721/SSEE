...
canonical $\Delta\mathrm{BIC}=-33.0$. The earlier
...
\begin{description}
  ...
  the canonical $\omega_m$-direct CMB fit gives $\Delta\mathrm{BIC}=-33.0$
  (full \texttt{plik} MCMC, $N=2409$) at the global anchor
...
% Titular canonico: full plik MCMC off-diag TTTEEE+lowl+lensing (Cobaya+clipy), chi2_BF SSEE 2771.3 vs LCDM 2773.1, N=2409 -> DeltaBIC=-33.0 (Paper 3 b1). plik_lite TTTEEE N=613 point est -> -23.9 cross-check. Diagonal N=5914 -> -34.9. Cobaya MIRA legacy -32.2 superseded.
Full \texttt{plik} MCMC & 2409 & $\omega_m$-direct & 2 & 6 & $\mathbf{-33.0}$ &
...
The canonical CMB result is the full \texttt{plik} MCMC row, $\Delta\mathrm{BIC}=-33.0$
($k=2$ vs $k=6$, $N=2409$, off-diagonal TTTEEE\,$+$\,lowl\,$+$\,lensing), with a
...
\textbf{Observational} &
  Planck~PR4 $\Delta\mathrm{BIC}=-33.0$ (full \texttt{plik} MCMC, $\omega_m$-direct canonical, $k=2$); $r_d^{\rm SSEE}=147.17$~Mpc ($0.32\sigma$) &
...
The $\Delta\mathrm{BIC}=-5.55$ (DESI dynamic) and $-33.0$ (CMB $\omega_m$-direct)
are not directly comparable (different $N$, backgrounds, and $\Lambda$CDM $k$ counts).
The canonical CMB value is the $\omega_m$-direct $\Delta\mathrm{BIC}=-33.0$
(full \texttt{plik} MCMC, $k=2$, $N=2409$), with the \texttt{plik\_lite} point
...
\texttt{plik} MCMC gives the canonical $-33.0$). Earlier register
...
In Paper~3, the canonical $\Delta\mathrm{BIC}=-33.0$ ($\omega_m$-direct, full
