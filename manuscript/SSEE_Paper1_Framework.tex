...
(derived analytically in companion Paper~4 as $0.0840$\,eV), and under the proposed
two-sector mechanism (Paper~6), the framework addresses the megaparsec
cluster mass discrepancy when combined with an IGIMF-corrected baryonic baseline \citep{Zhang2026}.
