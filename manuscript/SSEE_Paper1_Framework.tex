...
$w_a = -(\Omega+\varphi)/\mathrm{IGNIS}$ & $-0.66997$ & DESI DR2 (2025) & Postdiction \\
...
define the full assumption budget of SSEE.
...
$\wa$ encodes the dynamical departure from saturation driven by $P/\mathrm{IGNIS}$:
\begin{equation}
  \wz = -\frac{T_r}{M_v} \approx -0.840,
  \qquad
  \wa = -\frac{P}{\mathrm{IGNIS}}  \approx -0.670.
  \label{eq:ssee_pars}
\end{equation}
...
$w_0=-0.840$ at $>3\sigma$, SSEE is rejected; the observational or
...
$w_a$     & $-P_{sc}/\mathrm{IGNIS}$ & $-0.66997$ & DESI DR2 & A \\
...
$M_v$    & ATLAS / Maximal Invariant & $\varphi+\pi+K_v$ & 14.2788 & L1\\
\midrule
