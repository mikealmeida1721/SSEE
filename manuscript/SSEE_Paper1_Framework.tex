...
(OP-9, OP-10, OP-11 and OP-12 in \texttt{OPEN\_PROBLEMS.md}).
...
$\alpha_K^{\rm field} = 3\,\Omega_{\mathrm{DE}}(1+w_\phi)$ & $0.072567$ & Euclid weak lensing, $\sigma(\alpha_{K,0})\!\approx\!0.1$ (2026--2028): value lies \emph{below} the forecast error bar & Prediction (not yet discriminating) \\
$\beta_c = -\mathrm{AURA} = -(3\varphi+\pi)/2$ & $-3.997847$ & EFT plateau test (8 ICs, $\Delta=0.2\%$) & Retrodiction \\
\midrule
