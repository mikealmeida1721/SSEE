...
$H_{0,\rm local} = H_{0,\rm global} + \KALz \approx 73.5$~km\,s$^{-1}$\,Mpc$^{-1}$,
consistent with distance-ladder measurements.
...
$r = \varphi^{-10} = 0.0083$ is predicted for LiteBIRD ($\sim$2032).
\end{abstract}
