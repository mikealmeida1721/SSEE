...
\begin{itemize}\itemsep1pt
  ...
  \item \textbf{Postulate~I (Inflationary register).} The inflationary
        ...
        $n_s=1-2/N_*=1-\varphi^{-7}$ (matches Planck PR4 at $0.24\sigma$)
...
\textbf{Dynamic} &
  DESI~DR2 $\Delta\mathrm{BIC}=-5.55$; $w_0,w_a$ within $0.24\sigma$ (Pantheon+) &
...
The $\Delta\mathrm{BIC}=-5.55$ (DESI dynamic) and $-32.9$ (CMB $\omega_m$-direct)
