...
timestamped commitment: the point cannot move, and the released data have
moved past it twice without excluding it---it sat $0.05\sigma$ from the DR1
central value and $0.24\sigma$ from the tighter DR2 one (Pantheon+-class),
remaining inside the $68\%$ contour in both. DR3
(expected 2027) will either continue the pattern or exclude it. The arithmetic
is fixed in advance and leaves us no room: with the point immobile, the tension
scales inversely with the error bar, so a further $1.5\times$ tightening at
unchanged central values puts us at ${\sim}0.36\sigma$, and a $3\times$ one at
${\sim}0.7\sigma$. A joint ${>}3\sigma$ exclusion refutes the algebraic
background outright.
...
$\alpha_K^{\rm eff}=3\Omega_{\rm DE}(1+w_0)=0.4033$ (with $w_0=-0.839950$) used for the
...
$\Omega_c h^2 = 5.521406\times0.02242\times0.96556 = 0.11951$ ($0.41\sigma$ from Planck $0.1200\pm0.0012$).
