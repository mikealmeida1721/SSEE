...
$S_8=\sigma_8\sqrt{\Omega_m/0.3}$ (MCMC vs.\ raw KiDS-1000 $\xi_\pm$) & $0.7555\pm0.0192$ & KiDS-1000 $S_8=0.759\pm0.024$ ($0.11\sigma$) & Retrodiction \\
...
\paragraph{What is gained.} One postulate fewer, and four open problems closed
by dissolution rather than by resolution: OP-9 (UV origin of the mass
...
two-sector construction --- that is ordinary model-building, and it was
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item cosmic shear requires $S_8$ outside $0.7555\pm3\times0.0192$ once the
        primordial amplitude is fitted to the raw $\xi_\pm$ data with the
        \SSEE{} background held fixed (Paper~6).
