...
with the remaining open problems OP-9 and OP-11 for the dark-matter sector,
these define the full assumption budget of SSEE. (OP-14 is closed --- see the
neutrino input below; it is listed among the resolved entries of
...
\begin{itemize}\itemsep1pt
  \item The $\varphi$-DM mass $m_\phi=40.70$\,eV in Paper~6 follows from the
        ...
        $(\varphi,\pi)$ multiplier $\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS}_V=594.279999$,
