...
$\alpha_K^{\rm bare} = 3\,\Omega_{\mathrm{DE}}(1+w_\phi)$ & $0.072567$ & Euclid weak lensing, 2026--2028 & Prediction \\
...
\emph{bare-field} value $\alpha_K^{\rm bare}=3\Omega_{\rm DE}(1+w_\phi)=0.072567$ tabulated above
...
$\alpha_K^{\rm eff}=3\Omega_{\rm DE}(1+w_0)=0.403302$ (with $w_0=-0.839950$) used for the
...
\begin{itemize}\itemsep1pt
  ...
  \item \textbf{Postulate~I (Inflationary register).} The inflationary
        ...
        ($2\varphi^6=35.9$, $2\varphi^7=58.068884$, $2\varphi^8=94.0$).
