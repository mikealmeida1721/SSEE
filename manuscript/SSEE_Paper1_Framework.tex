...
(algebraically predicted as $0.0840$\,eV in companion Paper~4 via the Acoustic Residue
Theorem (Almeida Vallejo, in preparation); error $1.2\%$),
...
$\alpha_K = 3\,\Omega_{\mathrm{DE}}(1+w_\phi)$ & $0.403$ & Euclid weak lensing, 2026--2028 & Prediction \\
...
$\Omega_c h^2$ & $\mathrm{KAL}_0\times\Omega_b h^2\times n_s$ & $0.12184$ ($2.1\sigma$) & Planck 2018 & A \\
$r$       & $\varphi^{-10}$ & $0.00813$ & LiteBIRD 2032 & A \\
$\sum m_\nu$ & Acoustic Residue (Paper~4) & $0.084$ eV & Planck+BBN & A \\
\bottomrule
\end{tabularx}
\\[4pt]
...
$\Omega_c h^2 = 5.5214\times0.02285\times0.96556 = 0.12184$ ($2.1\sigma$ from Planck $0.1200\pm0.0012$).
