...
$\chi^2_{\rm SSEE}=1005.4$ versus $\chi^2_{\Lambda\rm CDM}=1003.8$, i.e.\
$\Delta\mathrm{BIC}=-24.0$ in favour of SSEE ($k=2$ vs $k=6$); the full
...
\begin{description}
  ...
  \texttt{plik\_lite} point estimate at $-24.0$ ($\chi^2_{\rm SSEE}=1005.4$). The
...
% Titular canonico: full plik MCMC off-diag TTTEEE+lowl+lensing (Cobaya+clipy), chi2_BF SSEE 2771.3 vs LCDM 2773.1, N=2354 -> DeltaBIC=-32.9 (Paper 3 b1). plik_lite TTTEEE N=613 point est -> -24.0 cross-check. Diagonal N=5914 -> -35.0. Cobaya MIRA legacy -32.2 superseded.
...
\texttt{plik\_lite} TTTEEE & 613 & $\omega_m$-direct & 2 & 6 & $-24.0$ &
...
superior fit. The \texttt{plik\_lite} point estimate ($\Delta\mathrm{BIC}=-24.0$,
$\chi^2_{\rm SSEE}=1005.4$ vs $1003.8$) and the diagonal-covariance spectra
...
estimate at $-24.0$ ($N=613$) and the diagonal cross-check at $-35.0$ ($N=5914$).
...
\texttt{plik\_lite} TTTEEE evaluation gives $\chi^2_{\rm SSEE}=1005.4$ vs
$\chi^2_{\Lambda\rm CDM}=1003.8$, $\Delta\mathrm{BIC}=-24.0$ (the full
...
\texttt{plik} MCMC, $k=2$; \texttt{plik\_lite} point estimate $-24.0$; legacy
