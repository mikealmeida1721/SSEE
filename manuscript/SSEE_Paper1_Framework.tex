...
$f\sigma_8(z{=}0.5)$ & mean $0.76\sigma$ vs 6 RSD surveys & BOSS/eBOSS/6dFGS & Retrodiction \\ % TODO Fase B: recompute f sigma8 con Om_m=0.30889 / m_phi=41.02
\midrule
\multicolumn{4}{l}{\textit{Paper 6 — $\varphi$-Dark Matter, two-sector}} \\
$m_\phi = \Sigma m_\nu^{\rm active}\,(\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS})$ & $41.02\,\mathrm{eV}$ & Matter $P(k)$ via $k_{\mathrm{fs}}$ (no SM portal) & Prediction \\
$k_{\mathrm{fs}}$ (Dodelson-Widrow from $m_\phi$) & $0.762\,h\,\mathrm{Mpc}^{-1}$ & DESI\,Y3 / Euclid $P(k)$, 2026--2028 & Prediction \\ % TODO Fase B: recompute k_fs (DW) con m_phi=41.02
\midrule
...
\begin{itemize}\itemsep1pt
  ...
  \item The $\varphi$-DM mass $m_\phi=41.02$\,eV in Paper~6 follows from the
        free-scalar mass term $m_\phi=\Sigma m_\nu^{\rm active}\,(\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS})$;
        the residual open question (OP-9) is the UV origin of the pure
        $(\varphi,\pi)$ multiplier $\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS}=594.28$,
...
$\phi$-DM mass $m_\phi=41.02$~eV via the Dodelson--Widrow relation. The
