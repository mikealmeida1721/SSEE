...
(Mahalanobis $\chi^2_{2D}=0.27$, i.e.\ $0.16\sigma$ against DESI+CMB+Pantheon+, $0.2$--$1.5\sigma$ across SN compilations; quantified in Paper~2
\citep{SSEE_paperII}).
...
\begin{description}
  ...
  $0.16\sigma$ from the official DESI~DR2 $w_0w_a$CDM posterior (Pantheon+; $0.2$--$1.5\sigma$ across SN compilations) in the $w_0$--$w_a$ plane.
...
\textbf{Dynamic} &
  DESI~DR2 $\Delta\mathrm{BIC}=-5.55$; $w_0,w_a$ within $0.16\sigma$ (Pantheon+) &
