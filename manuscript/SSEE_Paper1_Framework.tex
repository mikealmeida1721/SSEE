...
\caption{The Two-$\Omega_m$ criterion: which matter density enters each
  observable across the suite, and why. The two values are linked by the
  fixed MIRA factor $(3\varphi+\pi)/4\simeq1.9989$; the selection rule is
  the free-streaming scale $k_{\rm fs}=0.659\,h\,\mathrm{Mpc}^{-1}$.}
\label{tab:two_omega}
\small
