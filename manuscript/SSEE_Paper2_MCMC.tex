...
\begin{equation}
  ...
  \label{eq:rd_mapping}
\end{equation}
which is within $1\sigma$ of the Planck-inferred value $r_d = 147.09\pm0.26$\,Mpc \citep{HuSugiyama1996}.
...
mapped through the MIRA factor to $r_{d,\mathrm{eff}}\approx147\ \mathrm{Mpc}$
...
$\Omega_m^{\rm CMB} = \Omega_{\rm CDM} + \Omega_{\phi\text{-DM}} = 0.160 + 0.160 = 0.320$,
