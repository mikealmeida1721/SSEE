...
parameter, and never was a density (Paper~1, \S\ref{sec:two_omega_m} there;
...
$\sigma_8=0.8335$, $S_8=0.846$. That configuration imports the Planck--KiDS
tension; $A_s$ is one of the model's two free CMB-level parameters. Fitted to
the raw shear data instead, Paper~6 obtains $S_8=0.7555\pm0.0192$
($0.11\sigma$ KiDS) with a single matter sector.
