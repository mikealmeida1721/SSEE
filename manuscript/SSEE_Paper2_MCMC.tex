...
algebraic mass $m_\phi = 41.02$\,eV) contributes at scales below its
free-streaming cutoff $k_{\rm fs}=0.762\,h$\,Mpc$^{-1}$.
...
(\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS})$), not a fitted quantity.}
...
$S_8=0.847$ ($3.9\sigma$ KiDS); Paper~6 adds the $\varphi$-DM two-sector and finds $\sigma_8^{\rm eff}=0.748$, $S_8^{\rm eff}=0.766$ ($0.01\sigma$ KiDS).
