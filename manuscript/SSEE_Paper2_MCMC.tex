...
direct CMB fit of Paper~3 ($\Delta\mathrm{BIC}=-23.9$, $\omega_m$-direct
\texttt{plik\_lite} TTTEEE): if that fit had yielded $\chi^2_r\gg1$ or excluded
...
$\Delta\mathrm{BIC}=-23.9$ ($\omega_m$-direct plik\_lite TTTEEE, $k_{\rm SSEE}=2$ vs $k_{\Lambda\rm CDM}=6$),
...
likelihood ($\Delta\mathrm{BIC}=-23.9$, $\omega_m$-direct).
...
\begin{enumerate}
  ...
  \item Under the $\omega_m$-direct reframe the sound horizon falls out
    ...
    confirms it with the full CMB likelihood ($\Delta\mathrm{BIC}=-23.9$),
    reinterpreting the $21\sigma$ $\Omega_m$ tension as a diagnostic of
