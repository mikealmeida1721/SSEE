...
$\Omega_{m,\mathrm{dyn}}=(\pi-\varphi)/[2(\varphi+\pi)]=1+w_0=0.160050$ labels the
...
\begin{enumerate}
  ...
  \item \textbf{Damping tail.} $\Omega_{m,\mathrm{eff}}=0.160050$ must be
...
$0.160$: retaining $\Omega_m=0.160050$ in $E(z)$ with $r_d=147.17$ would predict
