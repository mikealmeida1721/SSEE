...
$N_{\rm steps}=25{,}000$ ($2.5\times10^6$ total evaluations), and a diagonal
covariance approximation for the DESI~DR2 BAO measurements; convergence
...
The cluster-mass sector achieves $\chi^2_r=0.126$ across seven clusters
(analytic forward-model) and $\chi^2_r=0.122$ in the four-cluster subset,
...
produces $\Delta\mathrm{BIC}=+206$; the form of $f_{DE}(z)$ is not the
primary driver.
...
$S_8 = 0.837$, within $0.4\sigma$ of Planck 2018 and the KiDS/DES range.
