...
Paper~4 derives $\sum m_\nu = 0.0840$\,eV algebraically via the
Acoustic Residue Theorem (error $1.2\%$ vs the empirical input here).}
...
\textbf{Note:} The values $\gamma_{\rm IS}=0.657$ and $S_8=0.837$ above use the
CMB-sector ($\Omega_{m,\mathrm{CMB}}=0.3199$) and the preliminary Paper~1 growth
index.  Paper~5 performs the full causal Israel--Stewart analysis with
