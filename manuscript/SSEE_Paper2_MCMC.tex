...
($\Omega_{m,\rm dyn}=0.160050$, $r_d=175.6$\,Mpc).}
With the algebraic $H_0=67.962$\,km\,s$^{-1}$\,Mpc$^{-1}$ and
$\Omega_m=0.160050$, the CPL dark-energy fraction at $z=2.33$ is
...
$\Omega_m=0.160050$ in $E(z)$ reduces matter domination at high $z$, lowers
...
EoS-sector $s_m=0.160$: retaining $\Omega_m=0.160050$ in $E(z)$ with $r_d=147.17$ would predict
