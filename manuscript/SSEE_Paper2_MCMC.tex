...
is conditional on the validity of the MIRA bridge derived in Paper~3.}
...
The companion Paper~3 (\citealt{AlmeidaSSEE2026paper3}) resolves the background
tension via the MIRA two-sector mechanism. A unified domain delineation is given
in Paper~1, \S\ref{sec:domain} \citep{AlmeidaSSEE2026a}.
...
(as defined in Paper~1 \S\ref{sec:falsification}) for the following reason:
