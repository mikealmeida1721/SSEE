...
\begin{equation}
  ...
  \label{eq:rd_mapping}
\end{equation}
which is within $1\sigma$ of the Planck-inferred value $r_d = 147.09\pm0.26$\,Mpc.
...
in its current form. Resolving it without destroying the underlying algebraic axioms likely requires an extension of the gravitational sector, such as non-minimal coupling or Kinetic Braiding in the Effective Field Theory of Dark Energy (EFT-DE).
...
$S_8 = 0.837$, within $0.4\sigma$ of Planck 2018, though tension with KiDS/DES remains.
