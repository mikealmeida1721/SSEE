...
A2142 \citep{Tchernin2016}, and A2744 \citep{Merten2011}.
...
algebraic mass $m_\phi = 5.71$\,eV) contributes at scales below its
...
Paper~6 derives $\sum m_\nu = 0.0840$\,eV algebraically via the
$\phi$-DM condensate mass relation $m_\phi/H_0^{\rm alg}=5.71/67.96$\,eV
(error $1.2\%$ vs the empirical input here).}
