...
$\wz$--$\wa$ plane.
The $H_0$ posterior is $66.55^{+0.44}_{-0.44}$~km\,s$^{-1}$\,Mpc$^{-1}$,
...
\begin{equation}
  H_0^{\rm prior,SSEE} \;=\; 67.068\pm0.54 \;\text{km\,s}^{-1}\,\text{Mpc}^{-1},
...
The \SSEE\ $H_0=66.55^{+0.44}_{-0.44}$\,km\,s$^{-1}$\,Mpc$^{-1}$ sits
within $0.74\sigma$ of the SSEE-self-consistent MIRA prior
($H_0^{\rm prior,SSEE}=67.068\pm0.54$, Eq.~\ref{eq:H0_prior_mira}),
...
\begin{figure}[H]
  ...
  ($H_0=67.068$, $\Omega_b h^2=0.02218$). The $H_0$ posterior
  ($66.55\pm0.44$) is consistent with the MIRA prior at $0.74\sigma$.}
...
($H_0^{\SSEE}=66.55$ vs $H_0^{\LCDM}=67.99$\,km\,s$^{-1}$\,Mpc$^{-1}$),
...
$H_0^{\rm MIRA} = 67.068\pm0.54$\,km\,s$^{-1}$\,Mpc$^{-1}$. These two
...
$H_0^{\rm MCMC}=66.55\pm0.44$\,km\,s$^{-1}$\,Mpc$^{-1}$,
...
$\Delta\mathrm{BIC}=-31.3$ (plik\_lite TTTEEE, $k_{\rm SSEE}=2$ vs $k_{\Lambda\rm CDM}=6$),
