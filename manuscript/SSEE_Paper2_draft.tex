...
not a free model in this plane; the relevant comparison is against CPL). The cluster-mass sector achieves $\chi^2_r=0.131$ across seven clusters
...
$\rdeff=\rdSSEE\cdot|\wz|\approx147.5$\,Mpc, consistent with the
Planck~2018 value within $2\sigma$. This reinterpretation is a
...
GitHub repository, initial commit \texttt{f8728c3} (2026 January 28).
\url{https://github.com/mikealmeida1721/SSEE_UNIFICADO}
(Permanent DOI via Zenodo in preparation).
