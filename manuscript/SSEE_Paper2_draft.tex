...
plane. The cluster-mass sector achieves $\chi^2_r=0.13$ across seven clusters with the IGIMF
...
$N_s=6000$ steps. After discarding $N_b=1500$ burn-in steps (the first
...
$N_{\rm eff}\gtrsim2800$ for \LCDM\ and CPL; the \SSEE\ chain shows
higher autocorrelation due to its constrained parameter space
($N_{\rm eff}\sim2060$), which is robust for marginal and joint statistics.
...
\midrule
\SSEE-V3.6 & 2 & $\sim$0.38 & $\sim$70 & $\sim$86  & $\sim$2060 \\
\LCDM      & 3 &      0.41  & 42.6     & 141.1    & 3380 \\
CPL        & 5 &      0.35  & 51.2     & 117.2    & 2813 \\
\bottomrule
\end{tabular}
\end{table}
