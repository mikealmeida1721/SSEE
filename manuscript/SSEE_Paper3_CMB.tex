...
$\sum m_\nu$ [eV] & 0.085 & SSEE (algebraic: 0.0840 eV, Paper~6) \\
$w_0$ & $-0.8399$ & $-T_r/M_v$ \\
...
Chains are run to Gelman--Rubin criterion $R{-}1 < 0.02$ (production run) or $R{-}1 < 0.05$ (validation). The \texttt{ssee\_paper3\_b1\_mcmc.py} script is fully reproducible:
\begin{verbatim}
