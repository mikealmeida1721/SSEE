...
Minimizing over $H_0 \in [66.5, 67.5]$ yields a true minimum for SSEE at $H_0 = 67.068$\,km\,s$^{-1}$\,Mpc$^{-1}$. The effective $\chi^2$ for SSEE is $1007.559$, compared to $1003.760$ for $\Lambda$CDM. The raw fit penalty is therefore only $\Delta\chi^2 = +3.799$ over $N=6469$ data points.
...
($w_0=-0.8399$, $w_a=-0.6700$, $H_0=67.068$ km\,s$^{-1}$\,Mpc$^{-1}$,
...
\begin{itemize}
  ...
  \item \textbf{Cobaya \texttt{plik\_lite}:} Minimum $\chi^2_{\mathrm{eff}} = 1007.559$ at $H_0 = 67.068$ km\,s$^{-1}$\,Mpc$^{-1}$.
