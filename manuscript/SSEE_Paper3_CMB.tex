...
\midrule
$H_0$ [km\,s$^{-1}$\,Mpc$^{-1}$] & $67.07 \pm 0.42$ & $67.32 \pm 0.54$ \\
$\log(10^{10}A_s)$    & $3.041 \pm 0.016$ & $3.044 \pm 0.016$ \\
$\tau$                & $0.054 \pm 0.008$ & $0.054 \pm 0.008$ \\
$n_s$                 & $0.96556$ (fixed)  & $0.965 \pm 0.004$ \\
$\Omega_b h^2$        & $0.02237$ (fixed)  & $0.02237 \pm 0.00015$ \\
$\Omega_c h^2$        & derived from $H_0$ & $0.1200 \pm 0.0012$ \\
$\sigma_8$ (CAMB)     & $0.822 \pm 0.006$ & $0.812 \pm 0.008$ \\
\midrule
$\chi^2_\mathrm{BF}$  & $1007.6$          & $1003.8$           \\
$\Delta\chi^2$        & $+3.8$            & (reference)        \\
$\Delta\mathrm{BIC}$ ($k=3$ vs $k=6$) & $-22.5$ & (reference) \\
$\Delta\mathrm{BIC}$ ($k=4$ vs $k=6$) & $-13.8$ & (reference) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
  ...
  \texttt{plik\_lite} MCMC. The tight $H_0$ constraint ($\pm0.42$\,km\,s$^{-1}$\,Mpc$^{-1}$)
...
SSEE+IS (CMB sector, $\gamma_\mathrm{IS}=0.554$, this work) & 0.820 & 0.847 \\
...
The kinetic function for a minimal Horndeski scalar with CPL equation of
state satisfies $\alpha_K(z)=3\,\Omega_{\rm DE}(z)\,[1+w_{\rm eff}(z)]$.
At $z=0$:
\begin{equation}
  \alpha_K^{\rm alg}(0) = 3\,\Omega_{\rm DE}\,(1+w_0)
    = 3\times 0.840\times 0.160 = 0.4032.
  \label{eq:alphak_pred}
\end{equation}
CLASS background integration gives $\alpha_K^{\rm CLASS}(0)=0.4033$,
a fractional deviation of $\Delta=0.005\%$, confirming the algebraic
derivation to numerical precision.
