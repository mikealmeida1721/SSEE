...
\caption{$f\sigma_8(z)$ predictions vs RSD data.
  ...
  and $\Omega_{m,\mathrm{cosm}}=0.320$ (gravitational background, $z\lesssim2.3$).
...
$\Omega_{m,\mathrm{cosm}}=0.320$ in Poisson source; $\approx\Lambda$CDM $0.73\sigma$).
Paper~6 two-sector gives $0.76\sigma$ (unchanged; the two-sector primarily reduces $S_8$
from $3.9\sigma$ to $2.6\sigma$ vs KiDS-1000).
