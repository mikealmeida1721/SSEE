...
at $0.16\sigma$ (DESI+CMB+Pantheon+; $0.2$--$1.5\sigma$ across SN compilations) \citep{DESI_DR2} and galaxy-cluster mass ratios with $\chi^2_r=0.122$.
...
two-sector $\varphi$-DM mechanism ($S_{8,\mathrm{eff}}=0.759$).
...
to $0.748$ reaches inside the $\sigma_8(R{=}8)$ window probed by RSD (half-mode
...
$S_8$ lensing tension, $S_{8,\mathrm{eff}}=0.759$, in $0.01\sigma$ agreement with KiDS-1000,
...
\begin{enumerate}
  ...
  \item \textbf{Two-sector free-streaming:} the $\phi$-DM free-streaming scale
    $k_{\rm fs}=0.762\,h\,\mathrm{Mpc}^{-1}$, predicted from the algebraic mass
    $m_\phi=41.02$~eV (Paper~6), should imprint on the matter power spectrum.
...
Combined with the Paper~2 results ($0.16\sigma$ on the DESI~DR2 $w_0w_a$CDM posterior,
