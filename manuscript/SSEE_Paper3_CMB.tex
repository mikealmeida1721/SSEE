...
The full TT+TE+EE+lensing analysis yields $\chi^2_r = 1.063, 1.053, 1.040, 0.732$
...
\begin{itemize}
  ...
  \item TT: $\chi^2_r=1.063$ over 1971 multipoles ($\Lambda$CDM: $1.043$).
  \item TE/EE: $\chi^2_r=1.053/1.040$, essentially matching $\Lambda$CDM.
  \item Lensing (PP): $\chi^2_r=0.732$ vs.\ $0.757$ for $\Lambda$CDM — SSEE marginally favoured.
