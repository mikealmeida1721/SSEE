...
$\Omega_{m,\rm dyn}=0.160$ is $1+w_0$, an equation-of-state parameter rather
...
redshift. In particular, the saturation $1+w_0=0.160$ never occupies a density
...
\begin{enumerate}
  ...
  \item \textbf{BAO consistency:} the BAO geometry is governed by the total
    ...
    $1+w_0=0.160$; SSEE must continue to fit DESI DR2 BAO within $2\sigma$
    ...
    $\Omega_{m,\mathrm{dyn}}=0.160$ in the geometry slot; that is a
