...
The acoustic scale is likewise consistent: $100\theta_*=1.04136$ (at the MCMC
...
anchor $H_0=67.962$ ($\omega_m$-direct, $\Omega_{m,\rm CMB}=0.30889$),
...
Evaluating at the single global anchor $H_0 = 3(\varphi+\pi)^2 = 67.962$\,km\,s$^{-1}$\,Mpc$^{-1}$ (which is also the \texttt{plik\_lite}-preferred value, $\Omega_{m,\rm CMB}=\omega_m/h^2=0.30889$), the effective $\chi^2$ for SSEE is $1005.409$, compared to $1003.760$ for $\Lambda$CDM. The raw fit penalty is therefore only $\Delta\chi^2 = +1.649$ over $N=613$ bandpowers.
...
($w_0=-0.8399$, $w_a=-0.6700$, $H_0=67.962$ km\,s$^{-1}$\,Mpc$^{-1}$,
$\Omega_m=0.30889$) and apply the IS growth-index correction post-processing:
\begin{equation}
...
\caption{$f\sigma_8(z)$ predictions vs the canonical Paper~5 RSD compilation
  ...
  Israel--Stewart growth ODE: $\Omega_{m,\mathrm{CMB}}=0.30889$
...
($\Omega_{m,\mathrm{CMB}}=0.30889$), compared to $0.860$ for $\Lambda$CDM. The
...
The $\chi^2/N=0.766$ quoted above uses $\Omega_{m,\mathrm{CMB}}=0.30889$, the CMB
...
performs this analysis with $\Omega_{m,\mathrm{CMB}}=0.30889$, $\gamma_\mathrm{IS}=0.554$,
...
\begin{enumerate}
  ...
  \item \textbf{Two-sector free-streaming:} the $\phi$-DM free-streaming scale
    ...
    $\Omega_{m,\mathrm{CMB}}=0.30889$ (independent predictions, no matter factor).
...
$\Omega_{m,\mathrm{CMB}}=\omega_m/h^2=0.30889$, no matter factor),
...
\begin{itemize}
  ...
  \item $\Omega_{m,\mathrm{CMB}}=0.30889$ within $0.88\sigma$ of Planck 2018.
