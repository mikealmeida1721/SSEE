...
$S_8 = 0.7555 \pm 0.0192$, i.e.\ $0.11\sigma$ from KiDS-1000
...
\midrule
$H_0$ [km/s/Mpc] & 67.96214 & SSEE anchor $3(\varphi+\pi)^2$ (Paper~9) \\
...
\begin{itemize}
  ...
  \item \textbf{\texttt{plik\_lite} TTTEEE ($\omega_m$-direct):} $\chi^2_{\mathrm{eff}} = 1005.41$ at $H_0 = 67.96214$ km\,s$^{-1}$\,Mpc$^{-1}$ (the CMB-minimising value with SSEE-fixed $\omega_b,\omega_c$).
...
The SSEE cascade, run on the measured SH0ES rate, returns a global background
$H_0^{\mathrm{glob}}=68.13$~km\,s$^{-1}$\,Mpc$^{-1}$
(Paper~9, $H_0^{\rm SH0ES}(1-f_{\rm scr})$, to be compared with the pure number
