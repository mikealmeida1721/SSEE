...
$\ell=220,\,536,\,812$ (Planck: $220,\,{\sim}540,\,{\sim}810$) and yields
$\chi^2_r=1.047$ vs.\ $\Lambda$CDM's $1.043$ over 1971 TT multipoles.
The full TT+TE+EE+lensing analysis yields $\chi^2_r = 1.047, 1.041, 1.041, 0.837$
for SSEE vs $1.043, 1.040, 1.039, 0.757$ for $\Lambda$CDM.
In the lensing sector (9 MV bandpowers), SSEE fits marginally worse than
$\Lambda$CDM ($\Delta\chi^2_r = +0.080$), though both $\chi^2_r<1$ indicate a good fit.
...
\textbf{SSEE+MIRA} ($\Omega_{m,\mathrm{CMB}}=0.320$) & \textbf{220} & \textbf{536} & \textbf{812} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
TT & 1971 & 1.047 & 1.043 & $+0.004$ \\
TE & 1967 & 1.041 & 1.040 & $+0.001$ \\
EE & 1967 & 1.041 & 1.039 & $+0.002$ \\
PP & 9    & 0.837 & 0.757 & $+0.080$ \\
\midrule
Combined$^{\dagger}$ & 5914 & 1.043 & 1.040 & $+0.003$ \\
\bottomrule
\end{tabular}
...
and $0.002$), indicating that SSEE+MIRA reproduces the polarization anisotropies
almost identically to $\Lambda$CDM.
TT shows the largest but still modest deviation ($+0.004$).
In the lensing potential sector (PP), SSEE achieves
$\chi^2_r=0.837$ vs.\ $0.757$ for $\Lambda$CDM --- slightly worse agreement
...
SSEE+MIRA & 2 & 1.043 & $-20.8$ \\
\bottomrule
\end{tabular}
\end{table}

Under the diagonal approximation, SSEE is favoured ($\Delta\mathrm{BIC}=-20.8$):
the combined $\chi^2_r=1.043$ lies close to $\Lambda$CDM's $1.040$, so the
parameter-count term ($\Delta k\,\ln N=-34.7$) dominates and rewards SSEE's
smaller parameter set. This diagonal cross-check is evaluated at $H_0=67.08$,
...
The diagonal result ($\Delta\mathrm{BIC}=-20.8$, evaluated at $H_0=67.08$) and the
...
\midrule
Diagonal (approx.) & TT+TE+EE+PP & 5914 & 2 & 6 & $-20.8$ (SSEE favoured) \\
...
\begin{itemize}
  \item Acoustic peaks at $\ell=220,\,536,\,812$, within $\Delta\ell\leq5$ of Planck PR4.
  \item TT: $\chi^2_r=1.047$ over 1971 multipoles ($\Lambda$CDM: $1.043$).
  \item TE/EE: $\chi^2_r=1.041/1.041$, essentially matching $\Lambda$CDM.
  \item Lensing (PP): $\chi^2_r=0.837$ vs.\ $0.757$ for $\Lambda$CDM — SSEE marginally disfavoured (both $\chi^2_r<1$).
