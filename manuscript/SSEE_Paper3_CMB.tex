...
$\ell=220,\,536,\,813$ (Planck: $220,\,{\sim}540,\,{\sim}810$) and yields
$\chi^2_r=1.045$ vs.\ $\Lambda$CDM's $1.043$ over 1971 TT multipoles.
The full TT+TE+EE+lensing analysis yields $\chi^2_r = 1.045, 1.041, 1.040, 0.880$
for SSEE vs $1.043, 1.040, 1.039, 0.757$ for $\Lambda$CDM.
In the lensing sector (9 MV bandpowers), SSEE fits marginally worse than
$\Lambda$CDM ($\Delta\chi^2_r = +0.123$), though both $\chi^2_r<1$ indicate a good fit.
...
Blue: SSEE+MIRA. Orange dashed: $\Lambda$CDM. Black points: Planck PR4
lensing (9 MV bandpowers). Lower panel: residuals normalised by $\sigma_L$.
SSEE achieves $\chi^2_r=0.880$ over the 9 bandpowers
...
\midrule
TT & 1971 & 1.045 & 1.043 & $+0.002$ \\
TE & 1967 & 1.041 & 1.040 & $+0.001$ \\
EE & 1967 & 1.040 & 1.039 & $+0.001$ \\
PP & 9    & 0.880 & 0.757 & $+0.123$ \\
\midrule
Combined$^{\dagger}$ & 5914 & 1.042 & 1.040 & $+0.002$ \\
\bottomrule
\end{tabular}
...
each), indicating that SSEE+MIRA reproduces the polarization anisotropies
...
$\chi^2_r=0.880$ vs.\ $0.757$ for $\Lambda$CDM --- slightly worse agreement
...
SSEE+MIRA & 2 & 1.042 & $-24.7$ \\
\bottomrule
\end{tabular}
\end{table}

Under the diagonal approximation, SSEE is favoured ($\Delta\mathrm{BIC}=-24.7$):
the combined $\chi^2_r=1.042$ lies close to $\Lambda$CDM's $1.040$, so the
...
The diagonal result ($\Delta\mathrm{BIC}=-24.7$, evaluated at $H_0=67.08$) and the
...
\midrule
Diagonal (approx.) & TT+TE+EE+PP & 5914 & 2 & 6 & $-24.7$ (SSEE favoured) \\
...
\begin{itemize}
  ...
  \item TT: $\chi^2_r=1.045$ over 1971 multipoles ($\Lambda$CDM: $1.043$).
  \item TE/EE: $\chi^2_r=1.041/1.040$, essentially matching $\Lambda$CDM.
  \item Lensing (PP): $\chi^2_r=0.880$ vs.\ $0.757$ for $\Lambda$CDM — SSEE marginally disfavoured (both $\chi^2_r<1$).
