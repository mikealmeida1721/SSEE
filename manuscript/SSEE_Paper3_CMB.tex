...
\begin{equation}
    \label{eq:bic_cobaya}
    \Delta\mathrm{BIC} = 3.799 + (2 - 6)\ln(6469) = -31.3.
\end{equation}
...
The SSEE canonical dynamic-sector value $H_0^{\mathrm{local}}=71.90$~km\,s$^{-1}$\,Mpc$^{-1}$
(Paper~9, MIRA-derived) addresses the persistent Hubble tension
\citep{Verde2019,DiValentino2021,Riess2022} at the $1.10\sigma$ level,
