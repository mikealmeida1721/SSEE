...
OSIRIS    & $\mathrm{MIKA}+\mathrm{KAL}-\mathrm{BIAL}$
          ...
          & 14.278880 \\[2pt]
MIKAEL\_V & $\varphi+\pi+\mathrm{KRYSTOS\_V}$
...
The \SSEE\ KAL constant $K = (\varphi+3\pi)/2 = 5.521$ numerically equals
the observed $H_{0,\rm local}-H_{0,\rm global}$ offset; the physical
mechanism is not yet derived from first principles (Type~P coincidence,
consistent with Paper~1).  The global and local Hubble constants are:
\begin{align}
