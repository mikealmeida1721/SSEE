...
The value
\begin{equation}
M_v \equiv 3(\varphi+\pi) = 3\,\Omega = 14.278879927\ldots
\label{eq:sigma9}
\end{equation}
...
$M_v$ & $3(\varphi+\pi)$           & $3\Omega$      & 14.278880 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{align}
  ...
  M_v    &= 3(\varphi+\pi)              \approx 14.2789 \quad \text{(Maximal Dimensional Invariant $= M_v$)}, \\
