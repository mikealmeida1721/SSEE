...
density, $\Omega_m=\omega_m/h^2=0.308881$ (no matter factor; OP-8 dissolved;
...
$H_0^{\rm glob}$ [km/s/Mpc]  & 67.962137 & vs $3(\varphi+\pi)^2$ & residual $+4.2\times10^{-6}$ & SH0ES-screened, $f_{\rm screen}$ complete (IR$+$UV) \\
