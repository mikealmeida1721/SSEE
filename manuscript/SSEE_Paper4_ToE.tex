...
$\Omega_b h^2 = (\pi-\varphi)/(3\Omega^2) = (\pi-\varphi)/H_0^{\rm SSEE} = 0.022418$ ($0.32\sigma$ from Planck~2018);
...
\begin{align}
\Omega_b h^2 &= \frac{\pi-\varphi}{3\Omega^2} = \frac{\pi-\varphi}{H_0^{\rm SSEE}} = 0.022418
\label{eq:Obh2} \\[4pt]
...
enters as the dimensionless value $67.962$, i.e.\ $H_0^{\rm SSEE}$ expressed in
...
\boxed{\Omega_c h^2 = K_{\rm AL}\,\Omega_b h^2\,n_s
      = 5.521406\times 0.02242\times 0.96556 = 0.119514}
\label{eq:omch2_IS}
\end{equation}
...
The \SSEE\ algebraic prediction $\Omega_b h^2 = (\pi-\varphi)/(3\Omega^2) = 0.022418$
...
The physical baryon density $\Omega_b h^2 = (\pi-\varphi)/(3\Omega^2) = 0.022418$ derived in
...
= (\pi-\varphi)/[3(\varphi+\pi)^2] = 0.022418$ ($0.32\sigma$ from Planck~2018).
...
\begin{itemize}
  ...
  \item $\Omega_c h^2 = K_{\rm AL}\,\Omega_b h^2\,n_s = 0.119514$ ($0.41\sigma$ from Planck, forward)
