...
$H_0^{\rm MCMC}=67.79\pm0.35$~km\,s$^{-1}$\,Mpc$^{-1}$ (Paper~2, under
...
anchor at $0.50\sigma$, and the \SSEE\ sound horizon matches \LCDM\
...
correction is applied, and the two agree to $0.50\sigma$.
...
ratio $|w_0|=T_r/M_v=0.839950$, an equation-of-state quantity carrying no
$H$, \emph{not} the density fraction $\Omega_{\rm DE}=0.691119$):
\begin{equation}
  \Sigma m_\nu^{\rm active}
