...
\item[(iv)] a preliminary local Hubble constant
$H_{0,\rm local} = H_0 + K_{\rm loc} = 73.48$~km\,s$^{-1}$\,Mpc$^{-1}$
($0.5\sigma$ from \citet{Riess2022}; numerical coincidence Type~P — no dimensional
derivation from first principles exists; reported for consistency with
the Zenodo register and superseded by the screening derivation of Paper~9,
...
\quad $H_{0,\rm local}$ [km/s/Mpc] & $3(\varphi+\pi)^2 + K$ & 73.48$^{\rm P}$  & $73.0\pm1.0$ & $0.5\sigma$ \\
...
$H_{0,\rm local}$ [km/s/Mpc]  & 73.48  & $73.0\pm1.0$  & $0.5\sigma$ & algebraic (Type~P$^\dagger$) \\
...
conditional on the UV--IR separability postulate. The value $73.48$ quoted here
is retained only for continuity with the Genesis~5.12 Zenodo register; the
canonical value is the Paper~9 result $72.86$~km\,s$^{-1}$\,Mpc$^{-1}$.
