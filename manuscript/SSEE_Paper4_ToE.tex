...
$H_{0,\rm local} = H_0^{\rm MIRA}/(1-f_{\rm scr}) = 71.90$~km\,s$^{-1}$\,Mpc$^{-1}$
($1.10\sigma$ from \citet{Riess2022}; the algebraic-anchor Type-P value
...
\quad $H_{0,\rm local}$ [km/s/Mpc] & $H_0^{\rm MIRA}/(1-f_{\rm scr})$ & 71.90$^{\rm P}$  & $73.0\pm1.0$ & $1.10\sigma$ \\
...
\bottomrule
\multicolumn{5}{l}{\footnotesize $^{\rm P}$~Canonical value: $f_{\rm scr}$ applied to the MIRA anchor $H_0^{\rm MIRA}=67.068$ gives $71.90$ ($1.10\sigma$).}\\
...
$H_0^{\rm MCMC}=66.55\pm0.44$~km\,s$^{-1}$\,Mpc$^{-1}$ (Paper~2, under
...
$H_{0,\rm local}$ [km/s/Mpc]  & 71.90  & $73.0\pm1.0$  & $1.10\sigma$ & MIRA-screened (canonical; Type~P alt.\ 72.86) \\
...
$H_0^{\rm MIRA}=67.068$~km\,s$^{-1}$\,Mpc$^{-1}$ (Paper~3), yielding the
canonical local value
$H_{0,\rm local} = H_0^{\rm MIRA}/(1-f_{\rm scr}) = 71.90$~km\,s$^{-1}$\,Mpc$^{-1}$
($1.10\sigma$ from \citet{Riess2022}). Applying the same screening to the
...
self-consistency check, the canonical $H_0^{\rm UV,MIRA} = 72.08$~km\,s$^{-1}$\,Mpc$^{-1}$
($0.93\sigma$; Type-P evaluation $73.04$, a numerical coincidence),
...
\begin{itemize}
  ...
  \item $H_{0,\rm local} = H_0^{\rm MIRA}/(1-f_{\rm scr}) = 71.90$ ($1.10\sigma$ from Riess~2022; Type-P alt.\ 72.86 at $0.17\sigma$)
