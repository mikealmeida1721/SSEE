...
\bottomrule
\multicolumn{5}{l}{\footnotesize $^{\rm P}$~Canonical value (2026 reframe): $f_{\rm scr}$ applied to the measured $H_0^{\rm SH0ES}=73.04$ returns $68.13$, i.e.\ $0.17\sigma$ from $3(\varphi+\pi)^2=67.962137$.}\\
