...
all converging to the same numerical value (two degenerate pairs arise from SOLAR$=$MAR and
IGNIS$=$KRYSTOS\_V; see Appendix~\ref{app:independence}), providing strong evidence against post-hoc tuning;
