...
\begin{enumerate}
\item[(i)] $H_0 = 3(\varphi+\pi)^2 = 67.96214$~km\,s$^{-1}$\,Mpc$^{-1}$ ($1.1\sigma$ from Planck~2018),
...
$H_0^{\rm glob} = H_0^{\rm SH0ES}(1-f_{\rm scr}) = 68.13$~km\,s$^{-1}$\,Mpc$^{-1}$
($0.17\sigma$ from the pure algebraic number $3(\varphi+\pi)^2=67.96214$),
...
\midrule
\textbf{Cosmology} & & & & \\
\quad $H_0$ [km/s/Mpc] & $3(\varphi+\pi)^2$ & 67.96214 & $67.4\pm0.5$ & $1.1\sigma$ \\
\quad $H_0^{\rm glob}$ [km/s/Mpc] & $H_0^{\rm SH0ES}(1-f_{\rm scr})$ & 68.13  & $3(\varphi+\pi)^2$ & $0.17\sigma$ \\
...
\bottomrule
\multicolumn{5}{l}{\footnotesize $^{\rm P}$~Canonical value (2026 reframe): $f_{\rm scr}$ applied to the measured $H_0^{\rm SH0ES}=73.04$ returns $68.13$, i.e.\ $0.17\sigma$ from $3(\varphi+\pi)^2=67.96214$.}\\
...
$\Omega = \varphi+\pi$:
\begin{equation}
\boxed{H_0 = M_v \times \Omega = 3(\varphi+\pi)^2 = 67.96214}
\label{eq:H0}
\end{equation}
\textbf{Dimensional note.} The number 67.96214 is compared to $H_0$ as measured
...
The value $H_0^{\rm alg}=67.96214$ is a pure geometric prediction.
...
the $\omega_m$-direct CMB anchor as prior, $H_0^{\rm alg}=67.96214$, Paper~3).
...
$1+w_0=0.160050$ as the background density, now corrected.
...
enters as the dimensionless value $67.96214$, i.e.\ $H_0^{\rm SSEE}$ expressed in
...
matter factor: $\Omega_{m,\rm dyn}=0.160050$ (DESI) and $\omega_m$ (CMB) are two
...
structural retention $K_{\rm AL} = \beta + \pi \approx 5.5214$:
\begin{equation}
...
\midrule
$H_0^{\rm alg}$ [km/s/Mpc]     & 67.96214 & $67.4\pm0.5$  & $1.1\sigma$ & algebraic (Type~P$^\dagger$) \\
$H_0^{\rm glob}$ [km/s/Mpc]  & 68.13  & vs $3(\varphi+\pi)^2$ & $0.17\sigma$ & SH0ES-screened (canonical) \\
...
$H_0^{\rm glob} = H_0^{\rm SH0ES}(1-f_{\rm scr}) = 68.13$~km\,s$^{-1}$\,Mpc$^{-1}$,
$0.17\sigma$ from the pure algebraic number $3(\varphi+\pi)^2=67.96214$, which
...
residual to $4.2\times10^{-6}$ ($H_0^{\rm glob,UV} = 67.96214$),
...
\begin{itemize}
  \item $H_0 = 3(\varphi+\pi)^2 = 67.96214$ ($1.1\sigma$ from Planck)
  ...
  \item $H_0^{\rm glob} = H_0^{\rm SH0ES}(1-f_{\rm scr}) = 68.13$ ($0.17\sigma$ from $3(\varphi+\pi)^2$, with Riess~2022 as the input; the MIRA register is superseded)
