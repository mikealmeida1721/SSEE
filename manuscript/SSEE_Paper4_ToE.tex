...
\begin{enumerate}
\item[(i)] $H_0/(\mathrm{km\,s^{-1}\,Mpc^{-1}}) = 3(\varphi+\pi)^2 = 67.96214$ ($1.1\sigma$ from Planck~2018),
...
$\Omega = \varphi+\pi$:
\begin{equation}
\boxed{\frac{H_0}{\mathrm{km\,s^{-1}\,Mpc^{-1}}} = M_v \times \Omega = 3(\varphi+\pi)^2 = 67.96214}
\label{eq:H0}
\end{equation}
...
\begin{itemize}
  \item $H_0/(\mathrm{km\,s^{-1}\,Mpc^{-1}}) = 3(\varphi+\pi)^2 = 67.96214$ ($1.1\sigma$ from Planck)
