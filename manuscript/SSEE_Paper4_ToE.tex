...
The CMB-sector \emph{total} matter density follows from the geometric identity
\begin{equation}
\Omega_{m,\rm CMB}^{\rm geom} = \frac{\pi-\varphi}{\pi+\varphi} = 0.3201,
\end{equation}
in $0.7\sigma$ agreement with Planck~2018 ($\Omega_m = 0.3153\pm0.007$). This
geometric route agrees to $0.054\%$ with the canonical two-sector value
$\Omega_{m,\rm CMB}^{\rm MIRA} = \mathrm{MIRA}\times\Omega_{m,\rm dyn} = 0.31993$
(Paper~6), the two being independent algebraic predictions on $\{\varphi,\pi\}$.
This is the
