...
dark energy, $c^2_s \ll 1$ --- but they are not the same number, and that the
two are genuinely distinct channels rather than two estimates of one quantity
remains asserted rather than derived. That is \textbf{OP-22b}. We note that
the gap, $0.021284$, is the whole of Paper~7's prediction, so the question is
sharp and not academic: a measurement of $c^2_s$ discriminates.
\end{tcolorbox}
