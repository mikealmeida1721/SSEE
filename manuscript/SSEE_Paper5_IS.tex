...
free CMB-level parameters, and fixing it imports the Planck--KiDS tension.
...
$\sigma_8=0.7446\pm0.0189$ and $S_8=0.7555\pm0.0192$ --- $0.11\sigma$ from
...
\begin{figure}[h!]
  ...
  \caption{$S_8$: from the single-sector challenge to the two-sector
    resolution. The prediction of this paper \emph{with $A_s$ held at the
    Planck value} ($S_8 = 0.846 \pm 0.006$, red) sits $3.5\sigma$ above
    ...
    $0.11\sigma$ from KiDS-1000 (green band). Grey points: Planck 2018,
