...
earlier versions of this abstract stated: $\Omega_{m,\mathrm{dyn}}=0.160$ is
...
conservative CLASS ceiling is higher still, $S_8^{\mathrm{ceiling}} = 0.846$.
...
gives $S_8^{\rm bar} = 0.758$ ($0.06\sigma$ DES-Y3; Paper~6, eq.~12) --- also
computed with $A_s$ fixed to Planck, hence a ceiling like the others and not a
prediction.
