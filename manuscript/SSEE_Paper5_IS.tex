...
\emph{Residual, still open.} The bare fluid value $c^2_{s,\rm bare}=\wz$ is the
constant-$w$ effective-fluid closure, not the field's adiabatic speed
($c^2_{s,\rm ad}\in[0.60,1]$, \S\ref{subsec:instability}). That the viscous
fluid mode and the field mode are genuinely distinct channels remains asserted
rather than derived; it is carried forward as \textbf{OP-22b}.
\end{tcolorbox}
