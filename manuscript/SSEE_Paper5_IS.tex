...
resolves by free-streaming ($S_8^{\rm eff}=0.759$, $0.01\sigma$ KiDS).
...
reducing $\sigma_8$ to $0.748$ and yielding $S_8^{\rm WDM} = 0.759$
...
\begin{figure}[h!]
  ...
  \caption{$S_8$: from the single-sector challenge to the two-sector
    ...
    lensing data) suppresses small-scale power, lands at $S_8 = 0.759$ ---
...
reduces $\sigma_8$ from $0.8335$ to $0.748$, recovering $S_8 \approx 0.759$
($<0.1\sigma$ of DES-Y3).
...
correction bringing it to $S_8 \approx 0.759$ (Paper~6).
