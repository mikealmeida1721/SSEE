...
in agreement with the official DESI DR2 $w_0w_a$CDM posterior at $0.16\sigma$ (Pantheon+; $0.2$--$1.5\sigma$ across SN compilations).
...
The CPL parameters~\eqref{eq:w0_wa} \citep{ChevallierPolarski2001,Linder2003} are consistent with DESI DR2 at $0.16\sigma$ (Pantheon+)
...
DESI DR2 $\chi^2$ & $0.16\sigma$ & $> 3\sigma$ & $> 3\sigma$ \\
\bottomrule
\end{tabular}
\end{table}
