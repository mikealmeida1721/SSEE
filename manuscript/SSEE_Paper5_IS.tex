...
SSEE predicts $H_0 = 3(\varphi+\pi)^2 \simeq 67.962\,\kms$ \citep{SSEE_Paper4},
...
MIRA $= (3\varphi+\pi)/4$ (two-sector $\phi$-DM basis, Paper~6) & $1.998924$ & $\Omega_m$ direct measurement & Stage IV CMB / 2030 \\
\bottomrule
\end{tabular}
\end{table}
