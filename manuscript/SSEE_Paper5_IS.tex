...
of the $\omega_m$-direct reframe ($\Omega_{m,\mathrm{CMB}}=0.308881$,
...
\begin{equation}
  \boxed{S_8^{\mathrm{SSEE,\,ceiling}}
    = 0.8335 \times \sqrt{\frac{0.308881}{0.3}}
    = 0.8335 \times 1.0147
    = 0.846 \pm 0.006.}
  \label{eq:S8_SSEE}
\end{equation}
