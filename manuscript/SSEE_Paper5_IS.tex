...
reducing $\sigma_8$ to $0.737$ and yielding $S_8^{\rm WDM} = 0.761$
...
$\phi$-DM transfer function break at $k_{\rm fs} = 0.493\,h/\mathrm{Mpc}$
(Paper~6).
...
reduces $\sigma_8$ from $0.820$ to $0.737$, recovering $S_8 \approx 0.761$
($<0.1\sigma$ of DES-Y3).
...
correction bringing it to $S_8 \approx 0.761$ (Paper~6).
