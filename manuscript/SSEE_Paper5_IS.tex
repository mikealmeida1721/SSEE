...
($m_\phi = 41.02\,\mathrm{eV}$, $k_{\rm fs} = 0.762\,h/\mathrm{Mpc}$).
The two-sector effective transfer function suppresses power at $k > k_{\rm fs}$,
reducing $\sigma_8$ to $0.748$ and yielding $S_8^{\rm WDM} = 0.766$
...
\begin{figure}[h!]
  ...
  \caption{$S_8$: from the single-sector challenge to the two-sector
    ...
    free-streaming below $k_{\rm fs} = 0.762\,h/\mathrm{Mpc}$
    ($m_\phi = 41.02$\,eV, forward prediction with no parameter fitted to
...
$\phi$-DM transfer function break at $k_{\rm fs} = 0.762\,h/\mathrm{Mpc}$
(Paper~6).
...
reduces $\sigma_8$ from $0.820$ to $0.748$, recovering $S_8 \approx 0.766$
($<0.1\sigma$ of DES-Y3).
