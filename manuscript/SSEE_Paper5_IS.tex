...
$\Omega_{m,\mathrm{eff}}/s_m = 0.989\pm 0.017 \to 1$, not~$\approx2$:
...
$r^*=0.1904$ is retained only as the scale that a two-fold enhancement would
...
\multicolumn{4}{l}{Mean ($k \geq 10\,H_0/c$, IS-stabilised):}
  & $0.989 \pm 0.017$ & \\
\multicolumn{4}{l}{Would require ($r = r^* = 0.1904$):}
  & $1.9989$ & \\
\multicolumn{4}{l}{$\Rightarrow$ bound: $|r| < 0.013$ for $k\geq2$, i.e.\ $<7\%$ of $r^*$}
  &  & \\
\bottomrule
\end{tabular}
\end{table}

The measured enhancement is $\mathcal{R} = 0.989 \pm 0.017$ at $k \geq 10\,H_0/c$:
consistent with unity, i.e.\ \emph{no} enhancement. The content of that number is
a bound on dark-energy clustering. The ratio $r = \delta_{\mathrm{DE}}/\delta_m$
is small and \emph{negative} at all scales, $|r| < 0.013$ already at
$k = 2\,H_0/c$ and falling as $k^{-2}$, with $|r| \to 0$ as $k$ increases ---
below $7\%$ of the $r^*=0.1904$ that a two-fold enhancement would have needed.
Dark energy in this model does not cluster at any scale probed here, and a
measurement of $\delta_{\rm DE}/\delta_m$ above the percent level at $z=0$ would
falsify it.
...
$\mathcal{R} = 0.989 \pm 0.017$ versus the former target
