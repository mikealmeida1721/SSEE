...
$\ztilde = \KALz/3$ is consequently not determined by anything in this layer,
and is not claimed to be. $\KALz$ is not idle in the framework --- it is
measured through $\omega_c = \KALz\,\omega_b\,n_s$, where a $10\%$ shift moves
$\omega_c$ by roughly $10\sigma$ against Planck --- but that constraint comes
from the dark-matter sector, not from viscosity.
