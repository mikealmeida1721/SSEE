...
$S_8=0.759\pm0.024$ at $0.11\sigma$: the tension
...
$0.11\sigma$ agreement. There is no $S_8$ tension in \SSEE{} once the
comparison is made against the raw shear data rather than against the
compressed statistic. We stress what does the work here: the background is
\emph{more} constrained in \SSEE{} than in $\Lambda$CDM, not less --- the
single amplitude $A_s$ is the only quantity free to move, and it moves to a
value that fits. The earlier reported tension of $3.5\sigma$ came from holding
$A_s$ at the Planck-preferred value, which imports the Planck--KiDS tension
into a model that does not otherwise have it.
...
summary statistics --- the growth sector shows no $S_8$ tension: against the
...
agreeing with the KiDS-1000 published value at $0.11\sigma$. The
