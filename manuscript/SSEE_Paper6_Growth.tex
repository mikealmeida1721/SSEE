...
shear data to fix it gives $S_8=0.8262\pm0.0054$, $2.7\sigma$ away. That
...
\begin{tabular}{lcc}
\toprule
$A_s$ determined by & $S_8$ & vs.\ KiDS-1000 \\
\midrule
raw KiDS-1000 $\xi_\pm$ (this work) & $0.7555\pm0.0192$ & $0.11\sigma$ \\
\SSEE{} fit to raw Planck \texttt{plik\_lite} & $0.8262\pm0.0054$ & $2.73\sigma$ \\
$\Lambda$CDM-fitted Planck value (borrowed) & $0.8229\pm0.0059$ & $2.59\sigma$ \\
\bottomrule
\end{tabular}
\end{center}

The first two rows are the same model with the same background, differing only
in the data used to set one number, and they sit $2.7\sigma$ apart. That
...
$2.7\sigma$ between the amplitude preferred by the CMB and the amplitude
