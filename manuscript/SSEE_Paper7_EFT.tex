...
Second, no published SSEE number depends on $\bc$: it appears in no
production script and in no entry of the canonical constant register.
...
\begin{itemize}
  ...
  \item $\alpha_K$ is \emph{not} observationally accessible, and we state
    ...
    $\alpha_K = 15.6$ from $\alpha_K = 0.16$.
