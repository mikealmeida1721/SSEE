...
the multiplier $\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS}_V$ from first principles;
...
item (UV origin of the multiplier $\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS}_V$,
...
\begin{enumerate}
  ...
  \item \textbf{Scalar mass $m_\phi = 40.70\,\mathrm{eV}$} (Paper~6):
        ...
        (\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS}_V)$ is falsified.
