...
selects the canonical one, consistent with the interpretation of
$m_\phi$ fixed by Paper~6.
...
\begin{enumerate}
  ...
  \item \textbf{Scalar mass $m_\phi = 36.95\,\mathrm{eV}$} (Paper~6):
        ...
        (\Omega_{\rm DNAV}^4+\AURA\cdot\KAL)$ is falsified.
