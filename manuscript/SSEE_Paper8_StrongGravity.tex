...
\begin{enumerate}
  ...
  \item \textbf{Lensing mass transition}: JWST strong-lensing of galaxy-scale
        ...
        \footnote{Observational status (2026 literature review, OP-13): SLACS,
        BELLS, and BELLS GALLERY samples (galaxy-scale lenses,
        $\thetaE\sim 1\text{--}2''$) report total density slope
        $\gamma=2.074\pm 0.2$ (slightly super-isothermal; Auger et al.\ 2010;
        Sonnenfeld et al.\ 2015, 2024) and no anomalous $\thetaE$ deficit
        relative to standard NFW+stellar models. These systems live well inside
        $\rV$ (galactic scales, dense baryonic cores), so the k-mouflage
        screening of \S\ref{sec:vainshtein} predicts
        $\thetaE^{\rm SSEE}\approx\thetaE^{\rm GR}$ in this regime, consistent
        with observations. The deficit prediction therefore applies in the
        narrower window where screening is partial and the two-sector
        free-streaming is operative — clean isolation of this regime is left
        to dedicated JWST + low-density-lens follow-up. See OPEN\_PROBLEMS.md
        OP-13.}
...
and the lensing amplification (this paper) --- is a structural feature
of the algebraic framework: exact for the first two entries, and accurate
to $0.03\%$ for the lensing entry via $\sqrt{\bc}\approx\MIRA$.
