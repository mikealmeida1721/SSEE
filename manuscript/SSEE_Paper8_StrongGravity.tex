...
$\Omega_{m,\mathrm{CMB}}/\Omega_{m,\mathrm{dyn}}=0.308881/0.160\approx1.93$ is
...
= 0.308881 = \Omega_{m,\mathrm{CMB}}$ --- the standard CMB-sector value
...
free-streaming.
The ratio of CDM to total is $\Omega_{\mathrm{CDM}}/\Omega_{m,\mathrm{CMB}}=0.160/0.308881 = 0.518$,
...
\begin{enumerate}
  ...
  \item \textbf{Sub-Mpc scale ($k \gtrsim k_{\mathrm{fs}}$, compact lenses)}: The $\phi$-DM
        ...
        $\Lambda$CDM expectation for the same total $\Omega_m=0.308881$.
