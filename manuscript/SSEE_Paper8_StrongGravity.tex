...
\begin{align}
  \rV^\odot   &= \sqrt{5.521^2\times3.998}\;\sqrt{(3\,\mathrm{km})(1.6\times10^{-35}\,\mathrm{m})}
                \;\approx\; 6\,\mathrm{km}\,, \label{eq:rV_sun}\\
  \rV^{10^{12}M_\odot}
              &\approx \sqrt{5.521^2\times3.998}\;\sqrt{(3\times10^{12}\,\mathrm{km})(1.6\times10^{-35}\,\mathrm{m})}
                \;\approx\; 2\times10^{-4}\,\mathrm{m}\,. \label{eq:rV_mw}
\end{align}
