...
of OP-9} (physical interpretation of $m_\phi=5.60$~eV; see
...
$k\lessgtr k_{\mathrm{fs}}=0.493\,h\,\mathrm{Mpc}^{-1}$, identifying
...
mapping, two-sector mass ratio). In the lensing sector the cantidad
...
The cantidad derived in this section as the lensing factor is
...
two cantidades agree to $0.03\%$ because $\AURA\approx 4$, which makes both
...
and $M = 8.81\,\mathrm{meV}$ is the UV cutoff from Paper~10~\citep{SSEE10}.
...
\begin{table}[h]
\centering
\caption{K-mouflage screening radius at the UV completion scale $M = 8.81\,\mathrm{meV}$
...
\begin{figure}[ht]
  ...
  \caption{%
    ...
    $M = 8.81\,\mathrm{meV}$ \citep{SSEE10,brax2014}.
...
of $m_\phi=5.60$~eV). Each interpretation of $m_\phi$ — as the mass of the
...
\begin{enumerate}
  ...
  \item \textbf{Scalar mass $m_\phi = 5.60\,\mathrm{eV}$} (Paper~6):
        ...
        scale $k_{\rm fs}(m_\phi) = 0.493\,h/\mathrm{Mpc}$ imprinted on the
...
\begin{enumerate}
  ...
  \item \textbf{Full k-mouflage profile}: The screening radius
        ...
        algebraically once Paper~10 sets $M \approx 8.81\,\mathrm{meV}$
