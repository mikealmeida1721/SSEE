...
\begin{abstract}
\noindent The physical interpretation of $m_\phi=40.70$~eV that this paper
...
= 40.70$~eV fixed forward by the $(\varphi,\pi)$ algebra). This selects the
...
$k\lessgtr k_{\mathrm{fs}}=0.754\,h\,\mathrm{Mpc}^{-1}$, identifying
...
On scales $k < k_{\mathrm{fs}} = 0.754\,h\,\mathrm{Mpc}^{-1}$, both the
...
\begin{figure}[ht]
  ...
  \caption{%
    ...
    For $k < k_{\rm fs}=0.754\,h/\mathrm{Mpc}$ (blue dashed), the $\phi$-DM sector
...
\begin{equation}
  f_{\mathrm{lens}}(k) \;=\;
  \begin{cases}
    1 & k < k_{\mathrm{fs}} = 0.754\,h\,\mathrm{Mpc}^{-1} \\
...
$m_\phi=40.70$~eV is fixed by Paper~6 as the mass of a free cosmological
...
\begin{enumerate}
  ...
  \item \textbf{Free-streaming cutoff} ($k_{\mathrm{fs}} = 0.754\,h\,\mathrm{Mpc}^{-1}$,
        ...
        $k = 0.754\,h\,\mathrm{Mpc}^{-1}$ would falsify the $\phi$-DM mass
        $m_\phi = 40.70\,\mathrm{eV}$.
  ...
  \item \textbf{Scalar mass $m_\phi = 40.70\,\mathrm{eV}$} (Paper~6):
        ...
        scale $k_{\rm fs}(m_\phi) = 0.754\,h/\mathrm{Mpc}$ imprinted on the
...
\begin{enumerate}
  ...
  \item \textbf{Two-sector signature}: SSEE predicts a scale-dependent
        lensing suppression near $k_{\mathrm{fs}} = 0.754\,h\,\mathrm{Mpc}^{-1}$,
