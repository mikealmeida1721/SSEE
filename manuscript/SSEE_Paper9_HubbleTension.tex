...
We adopt the \textbf{multiplicative form}~\eqref{eq:H0local} as the canonical
SSEE prediction, for the following physical reason.
...
A complete perturbative derivation integrating the perturbed Hubble flow over
$z \in [0, 0.15]$ in the SSEE background is deferred to future work (see
...
\paragraph{3.~UV completion of $M$ (addressed in Paper~10).}
...
is robust.
Paper~10 of this series \citep{Paper10} derives $M^4 = 45\alpha^2\rhoc = 5\phiG^8\rhoc$
