...
$4.2\times10^{-6}$ ($H_0^{\rm glob,UV} = 67.96214$), the small-scale
...
$\sK^{\rm full} = 0.41691$ ($+3.37\%$ over the IR value) and the UV output
$H_0^{\rm glob,UV} = 67.96214$\,km/s/Mpc, the small-scale
refinement of the same cascade.
...
$\Omega_m = \Omega_{m,\rm dyn} = 0.160050$ (Paper~1, Sec.~1.4, Two-$\Omega_m$
...
Paper~10,
\begin{equation}
  H_0^{\rm base} \;=\; 73.04 \times (1 - 0.069522)
