...
in the \emph{infrared} regime ($M\to\infty$), where $\sK=\sK^{\rm IR}=0.403302$
...
correction supplied by Paper~10, $\sK^{\rm full}=\sK^{\rm IR}+0.013608=0.416910$,
giving $\fsc^{\rm full}=0.069522$ and the single model value
$H_0^{\rm glob}=73.04\times(1-0.069522)=67.96214$~km/s/Mpc.  There is
...
$\pm0.970$, inherited from the SH0ES input, dominates over the residual
...
$H_0^{\rm glob}$ (\textbf{model value}, mult.) & $H_0^{\rm SH0ES}(1-\fsc^{\rm full})$ & $\mathbf{67.96214}$ km/s/Mpc & Paper~10, Eq.~(sKfullform) \\
...
the model value $H_0^{\rm glob} = 67.96214$\,km/s/Mpc --- not a second
...
Paper~10) the single model value $H_0^{\rm glob}=67.96214$~km/s/Mpc, whose
...
$H_0^{\rm SH0ES}$ is $\pm0.970$~km/s/Mpc and dominates it by five orders of
