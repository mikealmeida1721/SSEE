...
$H_0^{\rm glob}=67.962$\,km/s/Mpc---the output of the cascade, not the local
$H_0^{\rm SH0ES}$ that is its input---and the density that enters is the one
matter density of the model, $\Omega_m = 0.308881$, with the CPL equation of
...
compounded. The integral was fed $\Omega_m = \Omega_{m,\rm dyn} = 0.160050$ as
