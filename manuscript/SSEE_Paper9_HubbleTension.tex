...
$H_0^{\rm glob,IR}$ (Paper-9 IR result, mult.) & $H_0^{\rm SH0ES}(1-\fsc)$ & $68.13$ km/s/Mpc & Eq.~\eqref{eq:H0local} \\
$H_0^{\rm glob,IR}$ (Paper-9 IR result, add.)  & $H_0^{\rm SH0ES}/(1+\fsc)$ & $68.44$ km/s/Mpc & --- \\
