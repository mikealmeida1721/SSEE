...
The present mechanism is distinct from EDE \citep{Poulin2019} (modifies $r_d$
at $z > 1000$), from modified recombination (shifts CMB peaks), and from late
dark energy transitions (require $w(z) \neq$ CPL); see \citet{Schoneberg2022}
for a systematic comparison of proposed solutions.
