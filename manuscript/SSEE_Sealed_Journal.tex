...
gives $0.7555\pm0.0192$, $0.11\sigma$ from KiDS-1000. The $\varphi$-dark-matter
...
free parameters this model retains at CMB level, and pinning it to Planck
imports the Planck--KiDS discrepancy into a model that does not otherwise
carry it. Second, the target itself was model-conditioned: the published $S_8$
...
\end{equation}
i.e.\ $0.11\sigma$ from the KiDS-1000 value $0.759\pm0.024$, with
...
\begin{figure}[ht]
  ...
  fixed by the algebra --- $0.11\sigma$ from KiDS-1000 (green band). Grey
...
$S_8$ (MCMC vs.\ raw $\xi_\pm$) & growth  & $0.7555\pm0.0192$ ($0.11\sigma$ KiDS) & P6 & Retrodiction \\
...
$0.7555\pm0.0192$, $0.11\sigma$. No extension sector is required, and the one
