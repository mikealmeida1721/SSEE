...
base coupling; KAL the structural viscosity; AURA the screening amplitude; MIRA
...
$\Om^{\mathrm{dyn}}=0.160$ from the cosmological $\Om^{\mathrm{cosm}}=\omega_m/h^2=0.308881$, and
...
it with the bare dynamical value $\Om^{\mathrm{dyn}}=0.160$ degrades the
...
$H_0^{\rm SH0ES}=73.04$. Run forward, the model returns
$3(\varphi+\pi)^2/(1-f_{\rm scr}^{\rm UV})=73.0400~\kms$, which is the published
SH0ES central value at every digit that has been published. The leftover in the
inverse direction, $4\times10^{-6}~\kms$, therefore lies below the resolution of
...
$\Omega_{\rm DE}$; the numerical value $\beta_c\simeq-3.98991$ agrees with
...
(TT+TE+EE, $N=613$ bandpowers, nuisance parameters marginalised by the Planck
Collaboration), which gives $\chi^2_{\rm SSEE}=1005.41$ against
$\chi^2_{\Lambda\rm CDM}=1003.76$---a penalty of $1.65$ in fit for four fewer
free parameters---and
\begin{equation}
  \label{eq:dbic-cmb}
  \Delta\mathrm{BIC}(\text{SSEE}-\Lambda\text{CDM}) = -24.02 \qquad
...
\begin{figure}[ht]
  ...
  ($S_8=0.846\pm0.006$): $A_s$ held at the Planck value, which imports the
...
$S_8$ (MCMC vs.\ raw $\xi_\pm$) & growth  & $0.7555\pm0.0192$ ($\Lambda$CDM ctrl $0.7571$) & P6 & Retrodiction \\
...
$w_a$            & $-0.66997$              & $-P_{\rm sc}/I_g$ & DESI Y3 / Euclid BAO+SNe \\
...
structure. The $S_8$ ``tension'' at $0.846$ was an artefact of holding $A_s$ at
...
$0.7555\pm0.0192$, matching the $\Lambda$CDM control on the same data ($0.7571\pm0.0194$) with four fewer free parameters. No extension sector is required, and the one
