...
$9.51925$ while remaining structurally distinct. The value therefore cannot
...
$\pi$       & ---               & seed (IR)              & $\pi$                       & $3.14159$  \\
$\Omega$    & OMEGA             & $\varphi,\pi$          & $\varphi+\pi$               & $4.75963$  \\
$\beta$     & BIAL              & $\varphi,\pi$          & $(\varphi+\pi)/2$           & $2.37981$  \\
$\mathrm{KAL}$  & KAL           & $\beta,\pi$            & $(\varphi+3\pi)/2$          & $5.52141$  \\
$\mathrm{AURA}$ & AURA          & $\beta,\varphi$        & $(3\varphi+\pi)/2$          & $3.99785$  \\
$\mathrm{MIRA}$ & MIRA          & AURA                   & $(3\varphi+\pi)/4$          & $1.99892$  \\
$P_{\mathrm{sc}}$ & PYROS       & $\Omega,\varphi$       & $2\varphi+\pi$              & $6.37766$  \\
$I_g$       & IGNIS             & $\pi,\mathrm{PYROS}$   & $2(\varphi+\pi)$            & $9.51925$  \\
$K_v$       & KRYSTOS$_V$       & $\varphi,\pi,\Omega$   & $2(\varphi+\pi)$            & $9.51925$  \\
$T_r$       & TRIAL             & AURA                   & $3(3\varphi+\pi)/2$         & $11.99354$ \\
$M_v$       & ATLAS             & $\varphi,\pi,K_v$      & $3(\varphi+\pi)$            & $14.27888$ \\
\bottomrule
\end{tabular}
\end{center}
