...
\begin{figure}[t]
  ...
  $H_0=66.553\pm0.442~\kms$ and $\Omega_b h^2 = 0.02261\pm0.00048$
  (Eq.~\ref{eq:h0post}). Dashed lines mark the anchor inputs
  $(H_0=67.068~\kms,\ \Omega_b h^2 = 0.02218)$; the $16/50/84\%$ quantiles are
  indicated.}
  \label{fig:corner}
\end{figure}
...
\begin{table}[t]
  ...
  (\text{SSEE}-\Lambda\text{CDM})=-24.7$ over $N=5914$ data points reflects the
