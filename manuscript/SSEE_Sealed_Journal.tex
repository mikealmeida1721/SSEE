...
residual dependence remains and we name it rather than hide it: \texttt{plik\_lite}
marginalises its nuisance parameters within a $\Lambda$CDM analysis. A run of the
full \texttt{plik} likelihood with the ${\sim}20$ nuisance parameters sampled
explicitly, which removes that dependence, is under way and will be reported
separately.
