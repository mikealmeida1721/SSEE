...
Enumerating every ordered pair over the complete dictionary yields $378$ distinct
...
unique:
\begin{equation}
  |w_0|=0.840:\ \text{1 of 378},\qquad
  |w_a|=0.670:\ \text{1 of 378}\quad(\pm0.001).
...
\emph{complete} $50$-constant Genesis dictionary ($378$ distinct ratios in
$(0,5]$; constants sharing a value collapse to $22$ distinct
