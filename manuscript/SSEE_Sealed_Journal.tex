...
reproducing the anchor $3(\varphi+\pi)^2=67.9621$ to four decimals (residual
$5\times10^{-5}$, set by the quoted precision of $\alpha_K^{\rm full}$; we say
``to the quoted precision'' rather than ``exactly'' because the two are not
identical beyond that digit). We are deliberately precise about what is independent of what.
