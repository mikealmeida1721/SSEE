...
DR2 $w_0w_a$CDM posterior the agreement is at the $0.24\sigma$ level
(Pantheon+; $0.2$--$1.8\sigma$ across supernova compilations)
($\chi^2_{\rm 2D}=0.42$). A Markov-chain analysis combining DESI BAO with the
...
The falsification line is pre-registered: a joint exclusion of
$(-0.840,-0.670)$ at ${>}3\sigma$ in the DR3 $w_0$--$w_a$ plane, for the
combination with the compilation that DR3 itself identifies as most internally
consistent, refutes the algebraic background. No parameter exists with which
