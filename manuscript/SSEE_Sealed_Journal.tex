...
($\chi^2_{\rm 2D}=0.080$). A Markov-chain analysis combining DESI BAO with the
$\omega_m$-direct CMB anchor as prior yields $H_0=67.16\pm0.44~\kms$. The
...
solver with the $\omega_m$-direct cosmological matter fraction
$\Om^{\mathrm{cosm}}=0.30889$ ($=\omega_m/h^2$)
...
($3.9\sigma$), and the two-sector extension that resolves it ($S_8=0.759$,
