...
$w_a=-P_{\rm sc}/K_v=-0.670$, with no fitted amplitude. The point was fixed in
...
$\chi^2_{\rm 2D}=0.42$)---the prediction did not move while the data improved. A Markov-chain analysis combining DESI BAO with the
...
coefficient are open problems. Two of the framework's forward predictions bear
on \emph{unreleased} data and are \emph{independent} of the $\varphi$-dark-matter
extension: the fixed $(w_0,w_a)$ point, pre-registered to be excluded at
$>3\sigma$ if DESI~DR3 shifts it, and $r=\varphi^{-10}=8.1\times10^{-3}$,
...
$50$ named structural invariants---the \emph{complete} Genesis set,
...
share a value by construction---the $50$ names collapse to $22$ distinct numbers
