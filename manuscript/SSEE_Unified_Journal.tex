...
\caption{Matter power spectrum from CLASS with WDM suppression.
         ...
         ($\sigeff = 0.747$).
         The vertical dotted line marks $\kfs = 0.754\,h\,\mathrm{Mpc}^{-1}$.}
\label{fig:phiDM_pk}
\end{figure}
...
$\mphi = \Sigma m_\nu^{\rm active}(\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS})$ & $40.70$ eV & Matter $P(k)$ via $\kfs$ (no SM portal) & Prediction \\
...
\midrule
$\mphi$ & $\Sigma m_\nu^{\rm active}(\mathrm{SOLAR}^2\cdot\mathrm{KRYSTOS})$ & $40.70$ eV & --- (target: $\kfs$ via DESI~Y3/Euclid) \\
