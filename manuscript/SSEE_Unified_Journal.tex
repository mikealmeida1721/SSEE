...
numerical input, while the theoretical SSEE prediction is $\alphaK = 0.072567$.
...
where the EFTCAMB run uses the fluid-approximation input $\alphaK^{\rm fluid} = 0.403302$; the theoretical bare-field value derived in Paper~7 is $\alphaK = 0.072567$.
...
$\alphaK = 0.072567$ & $0.073$ & Euclid WL null test ($\alphaK < 0.1$ threshold) & Prediction \\
...
Standard-Model portal), $\alphaK = 0.072567$ (Euclid WL null test; a detection $\alphaK > 0.1$ would
