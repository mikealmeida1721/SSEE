...
\caption{$f\sigma_8(z)$ comparison. Data points: the six canonical RSD
         ...
         \textit{Red}: \SSEE\ two-sector, mean tension $0.70\sigma$.
...
\caption{$f\sigma_8$ tension for six RSD surveys. $\sigma_{\rm pull}$:
         ...
         giving mean $0.70\sigma$; at RSD scales ($k\ll k_{\rm fs}$) the
         $\varphi$-DM clusters as cold matter, so the two-sector reproduces the
         same mean $0.70\sigma$ --- both tie $\Lambda$CDM ($0.73\sigma$). (The
...
\midrule
6dFGRS     & 0.067 & $0.423\pm0.055$ & $+2.85\sigma$ & $+0.24\sigma$ \\
SDSS MGS   & 0.150 & $0.490\pm0.145$ & $+1.42\sigma$ & $-0.28\sigma$ \\
BOSS DR12  & 0.380 & $0.497\pm0.045$ & $+3.81\sigma$ & $-0.61\sigma$ \\
BOSS DR12  & 0.510 & $0.458\pm0.038$ & $+3.03\sigma$ & $+0.35\sigma$ \\
BOSS DR12  & 0.610 & $0.436\pm0.034$ & $+2.44\sigma$ & $+0.95\sigma$ \\
eBOSS DR16 & 1.480 & $0.462\pm0.045$ & $+2.50\sigma$ & $-1.75\sigma$ \\
\midrule
\textbf{Mean} & & & $2.68\sigma^*$ & $\mathbf{0.70\sigma}$ \\
\bottomrule
\end{tabular}
\end{table}

The two-sector $f\sigma_8$ mean ($0.70\sigma$) is statistically indistinguishable
