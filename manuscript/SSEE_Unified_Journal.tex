...
DESI~DR2 CPL posterior within $0.05\sigma$---a parameter-free postdiction, with no
...
$H_0 = 67.16^{+0.44}_{-0.44}$~km\,s$^{-1}$\,Mpc$^{-1}$ and $\Delta\mathrm{BIC}=-5.55$
...
\midrule
$H_0$ [km\,s$^{-1}$\,Mpc$^{-1}$] & $67.16^{+0.44}_{-0.44}$ & $67.42\pm0.48$ & free \\
...
confronts DESI (Paper~II, $0.05\sigma$), the Planck PR4 CMB
...
\item \textbf{Background sector.} The algebraic prediction
  ...
  $H_0 = 67.16\pm0.44$~km\,s$^{-1}$\,Mpc$^{-1}$ under the $\omega_m$-direct
