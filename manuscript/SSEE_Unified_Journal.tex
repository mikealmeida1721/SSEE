...
where the EFTCAMB run uses the fluid-approximation input $\alphaK^{\rm eff} = 0.403302$; the theoretical bare-field value derived in Paper~7 is $\alphaK = 0.072567$.
