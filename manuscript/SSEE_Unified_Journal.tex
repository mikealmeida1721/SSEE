...
global background $H_0^{\rm alg}=3(\phiG+\pi)^2=67.96214$ gives
$H_0^{\rm glob}=68.13$~km\,s$^{-1}$\,Mpc$^{-1}$, $0.17\sigma$ from the algebraic
...
\begin{alignat}{3}
  H_0   &= 3(\phiG+\pi)^2        &&\simeq 67.96214\;\mathrm{km\,s^{-1}\,Mpc^{-1}},  \label{eq:H0}\\
...
$H_0$ [km\,s$^{-1}$\,Mpc$^{-1}$]   & $65.87   \pm 1.17$    & $67.96214$   & $1.79\sigma$ \\
...
$H_0 = 3(\phiG+\pi)^2$ & $67.96214$ km/s/Mpc & Planck 2018 & Retrodiction \\
...
$H_0^{\rm glob} = H_0^{\rm SH0ES}(1-\fscr)$ & $68.13$ km/s/Mpc & $3(\phiG+\pi)^2=67.96214$ ($0.17\sigma$) & Retrodiction \\
\midrule
...
\item \textbf{Theoretical extensions.} The disformal strong-field regime predicts
  ...
  $H_0^{\rm alg}=3(\phiG+\pi)^2=67.96214$ yields
  $H_0^{\rm glob}=68.13$~km\,s$^{-1}$\,Mpc$^{-1}$, $0.17\sigma$ from $3(\varphi+\pi)^2$, with
...
$H_0^{\rm glob}$ & $H_0^{\rm SH0ES}(1-\fscr)$ & $68.13$ km/s/Mpc & $3(\phiG+\pi)^2=67.96214$ \\
