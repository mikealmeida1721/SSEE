...
\label{tab:mcmc_full}
egin{tabularx}{	extwidth}{X c c c}
\toprule
...
\begin{description}[itemsep=1pt]
  \item[SSEE full-$\Omega_m$ ($\omega_m$-direct canonical):] $\Omega_b = 0.04854$
    ...
    (total $\OmmCMB = 0.30889$; OP-8 dissolved, no matter factor), $w_0 = -0.8399$,
    $w_a = -0.6699$, $n_s = 0.96556$, $h = 0.67962$. The full matter density is
...
\textbf{SSEE ($\Omega_{m,\rm CMB}=0.30889$)}    & \textbf{221} & \textbf{537} & \textbf{814} & \textbf{0.14\%} \\
...
With $\Omega_{m,\rm CMB}=0.30889$, the peak positions agree with \LCDM\ to within $\Delta\ell \le 1$
...
\caption{CMB TT power spectrum from CLASS\@. \textit{Blue dashed}: \LCDM\ Planck~2018.
         ...
         $\OmmCMB=0.30889$ ($w_0=-0.840$, $w_a=-0.670$) --- peaks at
...
\caption{EFTCAMB stability and perturbation results.
         ...
         $\OmmCMB = 0.30889$ (OP-8 dissolved, no matter factor) for a direct comparison.}
\label{tab:eftcamb}
egin{tabularx}{	extwidth}{X c c}
\toprule
...
\midrule
$\sigma_8$ GR ($\OmmCMB = 0.30889$) & $0.814$ & \\
...
\caption{CMB TT power spectrum from EFTCAMB\@. \textit{Black}: GR run with the
         full $\omega_m$-direct canonical matter density $\OmmCMB = 0.30889$;
...
$\OmmCMB = \omega_m/h^2 = 0.30889$ (built from $\omega_b+\omega_c+\omega_\nu$,
...
\label{tab:params}
egin{tabularx}{	extwidth}{l X l X}
\toprule
