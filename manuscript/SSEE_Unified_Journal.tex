...
$0.04\sigma$ from the algebraic anchor) and $\Delta\mathrm{BIC}=5.68$ favouring
\SSEE\ over \LCDM\ ($5.59$ over CPL).
...
\midrule
$H_0$ [km\,s$^{-1}$\,Mpc$^{-1}$] & $67.62\pm0.40$ & $68.27\pm0.28$ & $67.26\pm0.51$ \\
Free parameters $k$ & 2 & 3 & 5 \\
$N_{\rm eff}$ & 78\,750 & 64\,505 & 44\,627 \\
$\Delta\mathrm{BIC}$ relative to SSEE & ref & $+5.68$ & $+5.59$ \\
$\Delta\mathrm{DIC}$ relative to SSEE & ref & $+4.91$ & $+3.27$ \\
...
With the total gravitating matter density $\Omega_m=\omega_m/h^2=0.30889$ in the
background geometry, \SSEE\ is favoured on every information criterion:
$\Delta\mathrm{BIC}=5.68$ over \LCDM\ and $5.59$ over CPL, $\Delta\mathrm{DIC}=
...
full $\omega_m$-direct CMB density $\OmmCMB=0.30889$ (OP-8 dissolved, no matter
...
\item \textbf{Background sector.} The algebraic prediction
  ...
  CMB anchor as prior ($0.04\sigma$ from the anchor), and $\Delta\mathrm{BIC} = 5.68$ favouring \SSEE\ over \LCDM.
