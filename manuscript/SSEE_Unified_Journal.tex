...
$\sigma_8=0.7446\pm0.0189$ and $S_8=0.7555\pm0.0192$, i.e.\ $0.11\sigma$ from
...
compounded. First, the quoted $S_8=0.846$ held the primordial amplitude $A_s$
fixed at the Planck-preferred value; $A_s$ is one of the two free parameters
this framework retains at CMB level, and pinning it to Planck imports the
Planck--KiDS discrepancy into a model that does not otherwise carry it. Second,
...
$S_8=0.759\pm0.024$ this is a $0.11\sigma$ agreement. The astrophysical
...
this table, which reported $0.93\sigma$ under free-streaming suppression, is
withdrawn with the particle.
...
$S_8$ (MCMC vs.\ raw KiDS-1000 $\xi_\pm$) & $0.7555\pm0.0192$ & KiDS-1000 ($0.11\sigma$) & Retrodiction \\
$\sigma_8$ ($A_s$ fixed to Planck; ceiling) & $0.8335$ & convention, not a prediction & --- \\
...
$\sigma_8 = 0.8335$, $S_8 = 0.846$ --- but that configuration imports the
...
$\sigma_8=0.7446\pm0.0189$, $S_8=0.7555\pm0.0192$ --- $0.11\sigma$ from
...
\item \textbf{Structure growth.} The IS perturbation analysis
  ...
  $S_8 = 0.7555\pm0.0192$, $0.11\sigma$ from KiDS-1000 (Paper~6); the
