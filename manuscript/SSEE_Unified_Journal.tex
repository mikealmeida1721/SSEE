...
official DESI~DR2 $w_0w_a$CDM posterior within $0.16\sigma$ (Pantheon+;
$0.2$--$1.5\sigma$ across SN compilations)---a parameter-free postdiction, with no
...
$(w_0, w_a)$ vs DESI DR2 $w_0w_a$CDM (Pantheon+) & $0.16\sigma$ & $0.7\sigma$ & — \\
\bottomrule
\end{tabular}
\end{table}
...
confronts DESI (Paper~II, $0.16\sigma$ Pantheon+), the Planck PR4 CMB
...
\item \textbf{Background sector.} The algebraic prediction
  ...
  $0.16\sigma$ of the official DESI~DR2 $w_0w_a$CDM posterior (Pantheon+).
