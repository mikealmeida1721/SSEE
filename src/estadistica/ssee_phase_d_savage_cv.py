...
OM_TOTAL = _C.OMEGA_M_TOTAL   # Ω_m EN EL ANCLA (diagnóstico) — NO congelar en ajustes
WM_ALG   = _C.OMEGA_M_H2      # ω_m = ω_b+ω_c+ω_ν ALGEBRAICO — lo que SSEE realmente fija.
