...
\begin{figure}[ht]
  ...
  \caption{$S_8$ with the primordial amplitude fixed versus fitted. The single-sector ceiling (red, $S_8=0.846\pm0.006$)
  carries the $3.5\sigma$ tension with KiDS-1000 reported in
  Eq.~\eqref{eq:s8}; fitting $A_s$ to raw $\xi_\pm$ data (green,
  $S_8=0.7555\pm0.0192$) lands $0.11\sigma$ from KiDS-1000 (green band). The
  retracted two-sector curve is no longer shown, and the
  free-streaming scale fixed by the forward-predicted mass
  free-streaming scale it used is withdrawn. Grey
...
($S_8=0.846$ with $A_s$ fixed to Planck) is not a tension once $A_s$ is fitted
to raw shear data ($S_8=0.7555\pm0.0192$, $0.11\sigma$); the two-sector
