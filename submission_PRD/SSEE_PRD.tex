...
$K_v$ (KRYSTOS) & $\varphi+\pi+\Omega$     & $9.51925$  & Structural (builds $M_v$; distinct from IGNIS) \\
...
(\S\ref{sec:open})%
\footnote{The forward prediction is the \emph{dimensionless} ratio
$m_\varphi/\Sigma m_\nu^{\rm active}=594.28$; its eV scale follows from the standard
relic-to-mass relation ($\Sigma m_\nu=93.14\,\mathrm{eV}\,\Omega_\nu h^2$), a physical
constant common to all cosmologies, anchored (like the Hubble units), not fitted.}; the suppression scale is a CLASS output, not a calibrated
...
four-dimensional integration invariant $M_v=\varphi+\pi+K_v=14.27888$ (a Sovereign
