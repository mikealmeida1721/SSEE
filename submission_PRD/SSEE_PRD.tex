...
\end{gathered}
  \label{eq:copylaw}
\end{equation}
The same law acts on the scaffold itself: $K_v=2\Omega$ (which in turn builds
$M_v=\varphi+\pi+K_v=3\Omega$, the denominator of $w_0$). The economy noted in
...
five-dimensional integration ceiling $M_v=\varphi+\pi+K_v=3\Omega=14.27888$, the
