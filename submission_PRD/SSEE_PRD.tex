...
to raw shear data ($S_8=0.7555\pm0.0192$; $\Lambda$CDM control on the same data: $0.7571\pm0.0194$; $\Delta\chi^2=2.65$ on the raw $\xi_\pm$ for four fewer parameters, $\Delta\mathrm{BIC}=19.0$); the two-sector
